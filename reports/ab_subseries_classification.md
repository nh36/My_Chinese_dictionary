...
- Generated subgroup heads inspected: 1096
- Subgroups newly marked with `a`: 121
- Subgroups newly marked with `b`: 111
- Uniform subgroups left unmarked because the root already signals the quality clearly: 408
- Mixed subgroups left unmarked: 452
- Unresolved subgroups left unmarked: 4

| GSC | Head | Plain root | Display root | Class | Added mark | MC forms | Note |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `01-09` | 豦 | `ka` | `k\textoverset{b}{a}` | `b` | yes | `giə, giəH, kiəX, giak, kiəH, giaek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `01-09` | 遽 | `ra` | `r\textoverset{b}{a}₂` | `b` | yes | `giəH, giə, kiəX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `01-20` | 䀠 | `kuak` | `ku\textoverset{b}{a}k` | `b` | yes | `kiuH, giu, giuH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `01-20` | 瞿 | `kuak` | `ku\textoverset{b}{a}k₂` | `b` | yes | `giu, giuH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `02-01` | 路 | `rak` | `r\textoverset{a}{a}k` | `a` | yes | `luH` | all extracted forms lack an i-medial after the onset |
| `02-01` | 輅 | `kak` | `k\textoverset{a}{a}k₃` | `a` | yes | `haek, luH, ṅaeH` | all extracted forms lack an i-medial after the onset |
...
| `02-05` | 𡭴 | `kak` | `k\textoverset{b}{a}k` | `b` | yes | `khiaek, xiaek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-06` | 郭 | `kuak` | `ku\textoverset{a}{a}k` | `a` | yes | `kwak, khwak` | all extracted forms lack an i-medial after the onset |
| `02-06` | 椁 | `ku\textoverset{a}{a}k` | `ku\textoverset{a}{a}k₂` | `a` | no | `kwak, khwak` | all extracted forms lack an i-medial after the onset |
| `02-08` | 蒦 | `quak` | `quak` | `mixed` | no | `hweak, qiwak, hwak, huH, qwak, 'waek` | the extracted forms point to both type a and type b |
| `02-10` | 赫 | `qhrak` | `qhr\textoverset{a}{a}k` | `a` | yes | `xaek, xaeH` | all extracted forms lack an i-medial after the onset |
| `02-12` | 霍 | `qu\textoverset{a}{o}k` | `qu\textoverset{a}{o}k` | `a` | no | `xwak, xəwk` | all extracted forms lack an i-medial after the onset |
| `02-13` | 亞 | `ʔak` | `ʔ\textoverset{a}{a}k` | `a` | yes | `qaeH, qaek, qaeX, qak, qu, quH` | all extracted forms lack an i-medial after the onset |
| `02-14` | 屰 | `ṅak` | `ṅak` | `mixed` | no | `ṅiaek, ṅak, ṅuH` | the extracted forms point to both type a and type b |
| `02-14` | 㖾 | `ṅak` | `ṅ\textoverset{a}{a}k` | `a` | yes | `ṅak, ṅuH` | all extracted forms lack an i-medial after the onset |
| `02-14` | 咢 | `ṅak` | `ṅ\textoverset{a}{a}k₂` | `a` | yes | `ṅak` | all extracted forms lack an i-medial after the onset |
| `02-15` | 噩 | `ṅ\textoverset{a}{a}k₃` | `ṅ\textoverset{a}{a}k₃` | `a` | no | `ṅak, ṅuH` | all extracted forms lack an i-medial after the onset |
| `02-16` | 度 | `tak` | `t\textoverset{a}{a}k` | `a` | yes | `dak, duH` | all extracted forms lack an i-medial after the onset |
| `02-17` | 石 | `tak` | `tak` | `mixed` | no | `jiek, ciek, ṭaek, ciak, ciaeH, thak, tuH` | the extracted forms point to both type a and type b |
| `02-17` | 橐 | `tak` | `t\textoverset{a}{a}k₂` | `a` | yes | `thak, tuH` | all extracted forms lack an i-medial after the onset |
| `02-18` | 庶 | `tak` | `t\textoverset{b}{a}k` | `b` | yes | `śiəH, ciəH, ciae, ciek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-22` | 乇 | `tak` | `t\textoverset{a}{a}k` | `a` | yes | `ṭaek, ḍaek, ṭaeH, ṭhaeH, thak, tuH, ḍae` | all extracted forms lack an i-medial after the onset |
...
| `02-23` | 㡿 | `qak` | `qak` | `mixed` | no | `chiek, thak, suH` | the extracted forms point to both type a and type b |
| `02-23` | 斥 | `qak` | `qak₃` | `mixed` | no | `chiek, ṭhaek, thak, suH` | the extracted forms point to both type a and type b |
| `02-24` | 赤 | `qhak` | `qh\textoverset{b}{a}k` | `b` | yes | `tshiek, chiek, śiaeH, śiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-24` | 赦 | `qhak` | `qh\textoverset{b}{a}k` | `b` | yes | `śiaeH, śiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-25` | 睪 | `lak` | `lak` | `mixed` | no | `yiek, duH, tuH, śiek, ḍaek, thak, dak` | the extracted forms point to both type a and type b |
| `02-25` | 擇 | `lak` | `l\textoverset{a}{a}k` | `a` | yes | `ḍaek, thak` | all extracted forms lack an i-medial after the onset |
| `02-26` | 射 | `lak` | `l\textoverset{b}{a}k` | `b` | yes | `jiek, źiaeH, yiek, źiek, ziaeH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-27` | 亦 | `qak` | `q\textoverset{b}{a}k` | `b` | yes | `yiek, tsiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-27` | 夜 | `rak` | `r\textoverset{b}{a}k` | `b` | yes | `yaeH, yiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-28` | 夕 | `rak` | `r\textoverset{b}{a}k` | `b` | yes | `ziek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-29` | 席 | `tak` | `t\textoverset{b}{a}k` | `b` | yes | `ziek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-31` | 乍 | `tsak` | `ts\textoverset{a}{a}k` | `a` | yes | `dẓaeH, tṣaeH, dzuH, tṣaek, tsak, dzak` | all extracted forms lack an i-medial after the onset |
| `02-31` | 作 | `tsak` | `ts\textoverset{a}{a}k₂` | `a` | yes | `tsak, dzak` | all extracted forms lack an i-medial after the onset |
| `02-32` | 昔 | `sak` | `sak` | `mixed` | no | `siek, dziek, dziaeH, tshiak, tshiek, tsiek, tṣiak, tshak, dzak, tsiaeH, tshuH, tṣhaek, dẓaeH, tshiəH, dẓeak` | the extracted forms point to both type a and type b |
...
| `02-34` | 朔 | `ṅak` | `ṅ\textoverset{a}{a}k` | `a` | yes | `ṣaewk, suH` | all extracted forms lack an i-medial after the onset |
| `02-35` | 舄 | `qak` | `q\textoverset{b}{a}k` | `b` | yes | `siek, siaeX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-35` | 寫 | `sha` | `sh\textoverset{b}{a}` | `b` | yes | `siaeX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `02-37` | 百 | `pak` | `p\textoverset{a}{a}k` | `a` | yes | `paek, maek` | all extracted forms lack an i-medial after the onset |
| `02-38` | 白 | `pak` | `p\textoverset{a}{a}k` | `a` | yes | `baek, paek, phaeH, phaek, pak, phak, bak` | all extracted forms lack an i-medial after the onset |
| `02-40` | 莫 | `mak` | `m\textoverset{a}{a}k` | `a` | yes | `maek, mak, muH, mu, mae, mek` | all extracted forms lack an i-medial after the onset |
| `02-40` | 幕 | `mak` | `m\textoverset{a}{a}k₂` | `a` | yes | `mak, mek` | all extracted forms lack an i-medial after the onset |
| `03-01` | 亢 | `ṅaṅ` | `ṅ\textoverset{a}{a}ṅ` | `a` | yes | `kaṅ, khaṅH, khaṅX, haṅ, haṅX, khaeṅ, hang` | all extracted forms lack an i-medial after the onset |
| `03-02` | 岡 | `kaṅ` | `k\textoverset{a}{a}ṅ` | `a` | yes | `kaṅ, kaṅH` | all extracted forms lack an i-medial after the onset |
| `03-03` | 畺 | `kaṅ` | `k\textoverset{b}{a}ṅ` | `b` | yes | `kiaṅ, giaṅ, giaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-03` | 彊 | `kaṅ` | `k\textoverset{b}{a}ṅ₂` | `b` | yes | `giaṅ, giaṅX, kiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-04` | 强 | `kaṅ` | `k\textoverset{b}{a}ṅ` | `b` | yes | `giaṅ, giaṅX, kiaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-04` | 強 | `kaṅ` | `k\textoverset{b}{a}ṅ₄` | `b` | yes | `giaṅ, giaṅX, kiaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-06` | 羌 | `qaṅ` | `q\textoverset{b}{a}ṅ` | `b` | yes | `khiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-07` | 竟 | `kaṅ` | `k\textoverset{b}{a}ṅ` | `b` | yes | `kiaeṅH, kiaeṅX, giaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-10` | 京 | `kaṅ` | `k\textoverset{b}{a}ṅ` | `b` | yes | `kiaeṅ, kiaeṅX, kiwaeṅX, giaeṅ, liaṅH, liak, liaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-10` | 景 | `kaṅ` | `k\textoverset{b}{a}ṅ₇` | `b` | yes | `kiaeṅX, kiwaeṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-11` | 更 | `kraṅ` | `kraṅ` | `mixed` | no | `kaeṅ, kaeṅH, kaeṅX, pyieṅX` | the extracted forms point to both type a and type b |
| `03-12` | 庚 | `kaṅ` | `k\textoverset{a}{a}ṅ` | `a` | yes | `kaeṅ, kaeṅH` | all extracted forms lack an i-medial after the onset |
...
| `03-14` | 行 | `kaṅ` | `k\textoverset{a}{a}ṅ` | `a` | yes | `ḫaeṅ, ḫaeṅH, ḫaṅ, ḫaṅH, ḫaeṅX` | all extracted forms lack an i-medial after the onset |
| `03-14` | 衡 | `kaṅ` | `k\textoverset{a}{a}ṅ₅` | `a` | yes | `ḫaeṅ` | all extracted forms lack an i-medial after the onset |
| `03-16` | 鄉 | `qaṅ` | `q\textoverset{b}{a}ṅ₂` | `b` | yes | `xiaṅ, xiaṅH, xiaṅX, śiaṅH, śiaṅX, hiaṅH, hiaṅX, hiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-18` | 向 | `qaṅ` | `q\textoverset{b}{a}ṅ` | `b` | yes | `hiaṅH, śiaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-20` | 央 | `ʔaṅ` | `ʔaṅ` | `mixed` | no | `qiaeṅ, qiaṅ, qiaṅX, qiaṅH, qaṅ, qaṅH` | the extracted forms point to both type a and type b |
| `03-22` | 光 | `kuaṅ` | `ku\textoverset{a}{a}ṅ` | `a` | yes | `kwaṅ, khwaṅH, kwaeṅ, hwaṅX` | all extracted forms lack an i-medial after the onset |
| `03-23` | 黃 | `kuaṅ` | `ku\textoverset{a}{a}ṅ` | `a` | yes | `ḫwaṅ, hwaeṅ, kwaṅH` | all extracted forms lack an i-medial after the onset |
...
| `03-24` | 皇 | `gaṅ` | `g\textoverset{a}{a}ṅ` | `a` | yes | `hwaṅ, ḫwaṅ, ḫwaeṅ, hwaeṅ` | all extracted forms lack an i-medial after the onset |
| `03-25` | 囧 | `kuaṅ` | `kuaṅ₂` | `mixed` | no | `kjwaengX, kiwaeṅX` | the extracted forms point to both type a and type b |
| `03-26` | 王 | `quaṅ` | `quaṅ` | `mixed` | no | `hiwaṅ, hiwaṅH, hiwaṅX, khiwaṅ, giwaṅ, giwaṅX, qiwaṅX, qwaṅ, kiwaṅH, kiwaṅX` | the extracted forms point to both type a and type b |
...
| `03-26` | 狂 | `quaṅ` | `qu\textoverset{b}{a}ṅ` | `b` | yes | `giwaṅ, giwaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-27` | 永 | `graṅ` | `gr\textoverset{b}{a}ṅ` | `b` | yes | `ḫiwaeṅX, ḫiwaeṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-28` | 兄 | `maṅ` | `m\textoverset{b}{a}ṅ` | `b` | yes | `hiwaeṅ, hiwaṅX, hiwaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-29` | 卬 | `ṅaṅ` | `ṅaṅ` | `mixed` | no | `ṅaṅ, ṅiaṅX, ṅiaeṅ, ṅiaeṅH` | the extracted forms point to both type a and type b |
| `03-31` | 章 | `taṅ` | `t\textoverset{b}{a}ṅ` | `b` | yes | `ciaṅ, ciaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-32` | 尚 | `taṅ` | `taṅ` | `mixed` | no | `jiaṅH, thaṅ, thaṅX, chiaṅX` | the extracted forms point to both type a and type b |
| `03-32` | 嘗 | `taṅ` | `t\textoverset{b}{a}ṅ₂` | `b` | yes | `jiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-32` | 敞 | `taṅ` | `t\textoverset{b}{a}ṅ₃` | `b` | yes | `chiaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-32` | 賞 | `taṅ` | `t\textoverset{b}{a}ṅ₄` | `b` | yes | `śiaṅ, śiaṅX, jiaṅ, jiaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-32` | 黨 | `taṅ` | `t\textoverset{a}{a}ṅ` | `a` | yes | `taṅX, thaṅX` | all extracted forms lack an i-medial after the onset |
| `03-32` | 堂 | `taṅ` | `t\textoverset{a}{a}ṅ₂` | `a` | yes | `daṅ, thaṅ, ṭhaeṅ` | all extracted forms lack an i-medial after the onset |
| `03-34` | 昌 | `kaṅ` | `k\textoverset{b}{a}ṅ` | `b` | yes | `chiaṅ, chiaṅH, jiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-35` | 長 | `taṅ` | `taṅ` | `mixed` | no | `ḍiaṅ, ḍiaṅH, ṭiaṅX, ṭiaṅH, ṭiaṅ, ṭhaeṅ, ṭhiaṅ, ṭhiaṅH, ḍaeṅ` | the extracted forms point to both type a and type b |
| `03-36` | 丈 | `taṅ` | `t\textoverset{b}{a}ṅ` | `b` | yes | `ḍiaṅX, ḍiaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-38` | 昜 | `laṅ` | `laṅ` | `mixed` | no | `yaṅ, daṅ, daṅX, śiaṅ, daṅH, yaṅH, tshiaṅ, ṭhiaṅH, ḍiaṅ, thaṅ, thaṅH` | the extracted forms point to both type a and type b |
| `03-38` | 傷 | `laṅ` | `l\textoverset{b}{a}ṅ` | `b` | yes | `śiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-38` | 湯 | `laṅ` | `laṅ₂` | `mixed` | no | `śiaṅ, thaṅ, daṅX, thaṅH, daṅH` | the extracted forms point to both type a and type b |
| `03-39` | 羊 | `qaṅ` | `q\textoverset{b}{a}ṅ` | `b` | yes | `yaṅ, yaṅX, ziaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `03-41` | 象 | `taṅ` | `t\textoverset{b}{a}ṅ` | `b` | yes | `ziaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-42` | 襄 | `naṅ` | `naṅ` | `mixed` | no | `siaṅ, śiaṅ, śiaṅH, śiaṅX, ñiaṅ, ñiaṅX, ñiaṅH, naṅX` | the extracted forms point to both type a and type b |
| `03-43` | 良 | `raṅ` | `raṅ` | `mixed` | no | `liaṅ, laṅH, laṅ` | the extracted forms point to both type a and type b |
| `03-43` | 郎 | `raṅ` | `r\textoverset{a}{a}ṅ₂` | `a` | yes | `laṅ` | all extracted forms lack an i-medial after the onset |
| `03-44` | 兩 | `raṅ` | `r\textoverset{b}{a}ṅ` | `b` | yes | `liaṅH, liaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-45` | 量 | `raṅ` | `r\textoverset{b}{a}ṅ` | `b` | yes | `liaṅ, liaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-48` | 倉 | `tsaṅ` | `tsaṅ` | `mixed` | no | `tshaṅ, tṣhiaṅH, tshiaṅ, tshiaṅX, tṣhiaṅX, tṣhiaṅ` | the extracted forms point to both type a and type b |
| `03-49` | 爿 | `tsaṅ` | `tsaṅ` | `mixed` | no | `tshiaṅ, tsiaṅ, tsiaṅH, śiaṅ, tsiaṅX, dziaṅ, tsaṅ, dzaṅ, dzaṅH, tṣiaṅH, tṣiaṅ, dẓiaṅ, dẓiaṅH` | the extracted forms point to both type a and type b |
...
| `03-55` | 相 | `saṅ` | `s\textoverset{b}{a}ṅ` | `b` | yes | `siaṅ, siaṅH, siaṅX, ṣiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-55` | 霜 | `saṅ` | `s\textoverset{b}{a}ṅ₅` | `b` | yes | `ṣiaṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-57` | 方 | `paṅ` | `paṅ` | `mixed` | no | `baṅ, piaṅ, piaṅX, biaṅ, phaṅ, paṅH, piaṅH, paeṅ, piaeṅH, phiaṅ, phiaṅX, phiaṅH` | the extracted forms point to both type a and type b |
...
| `03-59` | 彭 | `paṅ` | `p\textoverset{a}{a}ṅ` | `a` | yes | `baeṅ, baṅ, paṅ, paeṅ` | all extracted forms lack an i-medial after the onset |
| `03-61` | 丙 | `praṅ` | `pr\textoverset{b}{a}ṅ` | `b` | yes | `piaeṅX, piaeṅH, biaeṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-62` | 秉 | `praṅ` | `pr\textoverset{b}{a}ṅ` | `b` | yes | `piaeṅX, piaeṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-65` | 亡 | `maṅ` | `maṅ` | `mixed` | no | `miaṅ, miaṅH, maṅ, xwaṅ, xwaṅX, maeṅ, meaṅ, hwaṅ` | the extracted forms point to both type a and type b |
| `03-65` | 荒 | `maṅ` | `m\textoverset{a}{a}ṅ₃` | `a` | yes | `xwaṅ, xwaṅX, maṅ` | all extracted forms lack an i-medial after the onset |
| `03-65` | 芒 | `maṅ` | `maṅ₄` | `mixed` | no | `maṅ, miaṅ, xwaṅ, xwaṅX` | the extracted forms point to both type a and type b |
| `03-65` | 罔 | `maṅ` | `m\textoverset{b}{a}ṅ₂` | `b` | yes | `miaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-65` | 汒 | `maṅ₃` | `m\textoverset{a}{a}ṅ` | `a` | yes | `maṅ` | all extracted forms lack an i-medial after the onset |
| `03-65` | 巟 | `maṅ` | `m\textoverset{a}{a}ṅ₂` | `a` | yes | `hwaṅ, xwaṅ, xwaṅX, maṅ` | all extracted forms lack an i-medial after the onset |
| `03-66` | 朢 | `maṅ₅` | `m\textoverset{b}{a}ṅ₃` | `b` | yes | `miaṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-67` | 网 | `maṅ` | `m\textoverset{b}{a}ṅ` | `b` | yes | `miaṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `03-68` | 明 | `maṅ` | `maṅ` | `mixed` | no | `miaeṅ, meaṅ` | the extracted forms point to both type a and type b |
| `03-69` | 皿 | `maṅ` | `maṅ` | `mixed` | no | `miaeṅX, maeṅH, maeṅX` | the extracted forms point to both type a and type b |
| `03-69` | 孟 | `maṅ` | `m\textoverset{a}{a}ṅ₄` | `a` | yes | `maeṅH, maeṅX` | all extracted forms lack an i-medial after the onset |
| `04-02` | 亥 | `ky` | `ky` | `a` | no | `həyX, heak, həy, khəyH, həyH, kəy, heayX, ṅəyH, khək, hək, heay` | all extracted forms lack an i-medial after the onset |
| `04-03` | 戒 | `kryk` | `kryk` | `a` | no | `keayH, heayH, kəy, kək` | all extracted forms lack an i-medial after the onset |
| `04-04` | 其 | `ky` | `ky` | `b` | no | `gi, ki, kiH, giH, khi` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-04` | 基 | `ky` | `ky₃` | `b` | no | `ki, gi` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-04` | 欺 | `ky` | `ky₄` | `b` | no | `khi` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-05` | 己 | `ky` | `ky` | `b` | no | `kiX, kiH, khiX, giH, giX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-05` | 忌 | `ky` | `ky₆` | `b` | no | `giH, kiH, giX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-12` | 九 | `ku` | `ku` | `mixed` | no | `kiuwX, giuw, kwiyX, gwiy, kiuw, kiuwH, khaw, xaew, xiəwk` | the extracted forms point to both type a and type b |
| `04-12` | 軌 | `ku` | `ku₂` | `b` | no | `kwiyX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-13` | 久 | `kuy` | `kuy` | `b` | no | `kiuwX, kiuwH, yuwX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-14` | 丘 | `kuy` | `kuy` | `b` | no | `khiuw` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-15` | 求 | `ku` | `ku` | `b` | no | `giuw, kiuwH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-16` | 臼 | `kuy` | `kuy` | `b` | no | `giuwX, giuwH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-16` | 舊 | `kuy` | `kuy₆` | `b` | no | `giuwH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-17` | 又 | `gy` | `gy` | `b` | no | `ḫiuwH, ḫiuwX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-17` | 右 | `quy` | `quy₂` | `b` | no | `ḫiuwH, ḫiuwX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-17` | 有 | `quy` | `quy₃` | `mixed` | no | `ḫiuwX, qiuwk, ḫiuwH, ḫiuwk, ḫwiyX, hwəyX` | the extracted forms point to both type a and type b |
| `04-18` | 尤 | `gy` | `gy` | `b` | no | `ḫiuw` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-20` | 灰 | `quy₆` | `quy₆` | `a` | no | `hwəy, khwəy, mwəy, mwəyH` | all extracted forms lack an i-medial after the onset |
| `04-21` | 喜 | `qhy` | `qhy` | `b` | no | `xiX, xi, chiH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-23` | 疑 | `ṅy` | `ṅy` | `mixed` | no | `ṅi, ṅik, ṅiX, ṅəyH, ṅiṅ` | the extracted forms point to both type a and type b |
| `04-26` | 止 | `ty` | `ty` | `b` | no | `ciX, ṭhiX, chiX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-26` | 待 | `ty` | `ty₃` | `mixed` | no | `dəyX, ḍiX` | the extracted forms point to both type a and type b |
| `04-26` | 寺 | `ty` | `ty₂` | `mixed` | no | `ziH, śi, dəyX, ḍiX, dək, təyX, təṅX, ḍi, ciX, jiH, jiX, ji` | the extracted forms point to both type a and type b |
| `04-26` | 時 | `ty` | `ty₄` | `b` | no | `ji` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-27` | 之 | `ty` | `ty` | `b` | no | `ci` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-27` | 志 | `ty` | `ty₆` | `b` | no | `ciH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-29` | 止 | `ty` | `ty` | `b` | no | `ciX, ṭhiX, chiX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-29` | 待 | `ty` | `ty₁₀` | `mixed` | no | `dəyX, ḍiX` | the extracted forms point to both type a and type b |
...
| `04-30` | 㠯 | `ly` | `ly` | `b` | no | `yiX, ziX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `04-30` | 治 | `ly` | `ly₆` | `mixed` | no | `ḍi, ḍiH, dəyX` | the extracted forms point to both type a and type b |
| `04-32` | 巳 | `sy` | `sy` | `b` | no | `ziX, dẓiX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-34` | 巸 | `qy` | `qy₉` | `b` | no | `yi, xi, chiH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-34` | 熙 | `qy` | `qy₁₀` | `b` | no | `xi, chiH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-34` | 𦣞 | `qy` | `qy₈` | `b` | no | `yi, xi, chiH, ki, chiX, ciX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-35` | 里 | `ry` | `ry` | `mixed` | no | `liX, li, meay, meaj` | the extracted forms point to both type a and type b |
| `04-35` | 貍 | `ry` | `ry₂` | `mixed` | no | `li, meay, meaj` | the extracted forms point to both type a and type b |
| `04-38` | 乃 | `ny` | `ny` | `mixed` | no | `nəyX, ñiṅ, yiṅH` | the extracted forms point to both type a and type b |
| `04-38` | 仍 | `ny` | `ny₂` | `b` | no | `ñiṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-40` | 耳 | `ny` | `ny` | `mixed` | no | `ñiX, ñiH, ñi, ṇeak, ṭhiX` | the extracted forms point to both type a and type b |
| `04-41` | 而 | `ny` | `ny` | `mixed` | no | `ñi, ñiuwk, nəyH` | the extracted forms point to both type a and type b |
| `04-44` | 采 | `sry` | `sry` | `a` | no | `tshəyX, tshəyH` | all extracted forms lack an i-medial after the onset |
| `04-45` | 才 | `tsy` | `tsy` | `mixed` | no | `dzəy, tsi, tṣi, dẓeay` | the extracted forms point to both type a and type b |
| `04-45` | 𢦏 | `tsy` | `tsy₄` | `mixed` | no | `tsəy, dzəyH, tsəyH, tsəyX, dzəy, tṣiH, təyH` | the extracted forms point to both type a and type b |
...
| `04-61` | 丕 | `py` | `py₅` | `b` | no | `phiy, phiuw` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-61` | 咅 | `py` | `py₄` | `a` | no | `phuwH, bwəy, bwəyX, phuwX, puwX, bək, puwṅX, buwX, buw` | all extracted forms lack an i-medial after the onset |
| `04-62` | 負 | `py` | `py` | `b` | no | `biuwX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `04-65` | 某 | `my` | `my` | `mixed` | no | `muwX, mwəy, miuw` | the extracted forms point to both type a and type b |
| `05-01` | 克 | `kyk` | `kyk` | `a` | no | `khək` | all extracted forms lack an i-medial after the onset |
| `05-02` | 革 | `kyk` | `kyk` | `a` | no | `keak` | all extracted forms lack an i-medial after the onset |
| `05-04` | 亟 | `kyk` | `kyk` | `b` | no | `khiH, kik, gik` | all extracted forms show an i-medial or a dedicated palatal onset |
| `05-05` | 棘 | `kyk` | `kyk` | `b` | no | `kik` | all extracted forms show an i-medial or a dedicated palatal onset |
| `05-06` | 或 | `quyk` | `quyk` | `mixed` | no | `ḫwik, ḫwək, hwik, kwək, kweak` | the extracted forms point to both type a and type b |
| `05-06` | 國 | `quyk` | `quyk₂` | `a` | no | `kwək, kweak` | all extracted forms lack an i-medial after the onset |
| `05-10` | 意 | `qryk` | `qryk` | `mixed` | no | `qiH, qeayH, qi, qik, qiX` | the extracted forms point to both type a and type b |
| `05-12` | 直 | `tyk` | `tyk` | `mixed` | no | `ḍiH, ḍik, ṭik, jik, dək, ṭiH` | the extracted forms point to both type a and type b |
| `05-13` | 戠 | `tyk` | `tyk` | `mixed` | no | `cik, dək, ciH, śiH, śik, chiH` | the extracted forms point to both type a and type b |
| `05-15` | 敕 | `tyk` | `tyk` | `b` | no | `ṭhik` | all extracted forms show an i-medial or a dedicated palatal onset |
| `05-16` | 弋 | `lyk` | `lyk` | `mixed` | no | `yik, śik, ṭhik, śiH, thək, dək, dəyH, thəyH, dojH` | the extracted forms point to both type a and type b |
| `05-16` | 式 | `lyk` | `lyk₂` | `b` | no | `śik, ṭhik, śiH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `05-16` | 代 | `lyk` | `lyk₃` | `a` | no | `dəyH, thəyH, dək, dojH` | all extracted forms lack an i-medial after the onset |
...
| `06-09` | 登 | `tyṅ` | `tyṅ₂` | `mixed` | no | `təṅ, təṅH, dəṅH, ḍiṅ, ciṅH, tsyingX` | the extracted forms point to both type a and type b |
...
| `06-12` | 爯 | `tyṅ` | `tyṅ` | `b` | no | `chiṅ, chiṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `06-13` | 朕 | `ɡlum` | `ɡlum₂` | `mixed` | no | `ḍimX, ḍinX, yiṅH, jiṅ, śiṅ, śiṅH, dəṅ, dək` | the extracted forms point to both type a and type b |
| `06-15` | 乘 | `lyṅ` | `lyṅ` | `b` | no | `jiṅ, jiṅH, zyingH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `06-16` | 升 | `tyṅ` | `tyṅ` | `b` | no | `śiṅ, ciṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `06-18` | 能 | `ny` | `ny` | `a` | no | `nəy, nəṅ, thəyH` | all extracted forms lack an i-medial after the onset |
| `06-19` | 曾 | `tsyṅ` | `tsyṅ` | `mixed` | no | `dzəṅ, tsəṅ, dziṅ, dzəṅH, tsiṅH` | the extracted forms point to both type a and type b |
| `06-20` | 朋 | `pyṅ` | `pyṅ` | `mixed` | no | `bəṅ, pəṅH, pəṅ, peaṅ, piṅ, bong` | the extracted forms point to both type a and type b |
| `06-20` | 崩 | `pyṅ` | `pyṅ₂` | `a` | no | `pəṅ, bəṅ, pəṅH, peaṅ` | all extracted forms lack an i-medial after the onset |
| `06-21` | 冫 | `  *pyṅ` | `  *pyṅ` | `b` | no | `piṅ, biṅ, biṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `06-21` | 冰 | `pyṅ` | `pyṅ₃` | `b` | no | `piṅ, biṅ, biṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `07-12` | 啻 | `tek` | `tek₂` | `mixed` | no | `śieH, dek, śiek, ciek, ḍiek, ḍeak, ṭeak` | the extracted forms point to both type a and type b |
| `07-12` | 適 | `tek` | `tek₃` | `mixed` | no | `śiek, ciek, ḍiek, ḍeak, ṭeak` | the extracted forms point to both type a and type b |
| `07-13` | 知 | `tre` | `tre` | `b` | no | `ṭie, ṭieH, ḍie` | all extracted forms show an i-medial or a dedicated palatal onset |
| `07-14` | 是 | `te` | `te` | `mixed` | no | `jieX, dey, jie, cie, kyieH, śieH, tey, teyX, theyX, thegX, deyH, ḍieX, jik` | the extracted forms point to both type a and type b |
...
| `07-28` | 徙 | `say` | `s\textoverset{b}{a}y` | `b` | yes | `sieX, ṣieX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `07-29` | 卑 | `pe` | `pe` | `mixed` | no | `pyie, pyieX, pie, byie, beyX, bek, byiek, byit, byieX, beaṅX, pheyX, bey, peaX, beaH, bea, peṅX` | the extracted forms point to both type a and type b |
| `07-29` | 庳 | `pe` | `pe₂` | `mixed` | no | `byieX, beaṅX, byie` | the extracted forms point to both type a and type b |
| `07-31` | 弭 | `me` | `me` | `mixed` | no | `myieX, mey` | the extracted forms point to both type a and type b |
| `08-02` | 鬲 | `rek` | `rek` | `a` | no | `keak, lek, heak, ṅek` | all extracted forms lack an i-medial after the onset |
| `08-04` | 戹 | `qik₂` | `qik₂` | `a` | no | `qeak, qeaH` | all extracted forms lack an i-medial after the onset |
| `08-04` | 厄 | `qrik` | `qrik` | `a` | no | `qeak, qeaH` | all extracted forms lack an i-medial after the onset |
| `08-05` | 益 | `ek` | `ek` | `mixed` | no | `qyiek, qeak, ṅek, qeyH, qyieH, qeaH` | the extracted forms point to both type a and type b |
| `08-05` | 嗌 | `ek` | `ek₂` | `mixed` | no | `qyiek, qeak, ṅek` | the extracted forms point to both type a and type b |
| `08-08` | 役 | `quek` | `quek` | `b` | no | `yiwek, yiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `08-09` | 畫 | `kuek` | `kuek` | `a` | no | `ḫweaH, ḫweak, hweak` | all extracted forms lack an i-medial after the onset |
| `08-10` | 狄 | `lek` | `lek` | `a` | no | `dek, thek` | all extracted forms lack an i-medial after the onset |
| `08-12` | 易 | `lek` | `lek` | `mixed` | no | `yieH, yiek, thek, sek, theyH, śiek, deyH, siek, sieH, zyeX` | the extracted forms point to both type a and type b |
| `08-13` | 秝 | `rek` | `rek` | `a` | no | `lek` | all extracted forms lack an i-medial after the onset |
| `08-13` | 厤 | `rek` | `rek₃` | `a` | no | `lek` | all extracted forms lack an i-medial after the onset |
| `08-14` | 朿 | `tsek` | `tsek` | `mixed` | no | `tshieH, tshiek, tsiek, tṣheak` | the extracted forms point to both type a and type b |
| `08-14` | 責 | `tsek` | `tsek₂` | `mixed` | no | `tṣeaH, tṣeak, dẓeak, tṣheak, tsieH, tsiek, tsek, dzieH, tsreaH` | the extracted forms point to both type a and type b |
| `08-15` | 册 | `tshrek` | `tshrek` | `a` | no | `tṣheak` | all extracted forms lack an i-medial after the onset |
| `08-17` | 脊 | `tsek` | `tsek` | `b` | no | `dziek, tsiek` | all extracted forms show an i-medial or a dedicated palatal onset |
| `08-18` | 析 | `sek` | `sek` | `a` | no | `sek` | all extracted forms lack an i-medial after the onset |
| `08-19` | 辟 | `pek` | `pek` | `mixed` | no | `bek, byiek, pyiek, phyiek, pek, phek, byieH, mek, peak, pyieH, phyieH, peyH, beyH` | the extracted forms point to both type a and type b |
| `08-24` | 脈 | `mik` | `mik` | `a` | no | `meak` | all extracted forms lack an i-medial after the onset |
| `09-01` | 巠 | `leṅ` | `leṅ` | `mixed` | no | `keṅ, keṅX, keṅH, kheṅH, heṅH, heṅ, kyieṅH, gyieṅ, kyieṅX, khyieṅ, khyieṅH, heaṅ, kheaṅ, ḫeaṅ, ṅeaṅ, ṭhieṅ` | the extracted forms point to both type a and type b |
| `09-01` | 輕 | `leṅ` | `leṅ₂` | `mixed` | no | `khyieṅ, khyieṅH, kheṅH` | the extracted forms point to both type a and type b |
| `09-02` | 殸 | `qeṅ` | `qeṅ` | `mixed` | no | `kheṅH, kheṅX, heṅ, śieṅ` | the extracted forms point to both type a and type b |
| `09-03` | 敬 | `kreṅ` | `kreṅ` | `b` | no | `kiaeṅH, kiaeṅ, giaeṅ, giaeṅH, kiaeṅX, kyieṅX, giaeṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `09-04` | 刑 | `keṅ` | `keṅ₃` | `mixed` | no | `heṅ, kiaeṅ` | the extracted forms point to both type a and type b |
| `09-05` | 幸 | `keṅ` | `keṅ` | `a` | no | `ḫeaṅX, ḫeṅX` | all extracted forms lack an i-medial after the onset |
| `09-06` | 耿 | `keṅ` | `keṅ` | `a` | no | `keaṅX, khweṅX` | all extracted forms lack an i-medial after the onset |
| `09-07` | 頃 | `kueṅ` | `kueṅ` | `b` | no | `khiwieṅ, khiwieṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `09-08` | 冋 | `ɡeṅ` | `ɡeṅ` | `a` | no | `kweṅ, kweṅX, khweṅX, ḫweṅX` | all extracted forms lack an i-medial after the onset |
| `09-09` | 榮 | `queṅ` | `queṅ₂` | `mixed` | no | `ḫiwaeṅ, ḫiwaeṅH, ḫweaṅ` | the extracted forms point to both type a and type b |
| `09-10` | 嬰 | `qeṅ` | `qeṅ` | `mixed` | no | `qyieṅ, qeaṅ` | the extracted forms point to both type a and type b |
| `09-11` | 丁 | `teṅ` | `teṅ` | `a` | no | `teṅ, ṭeaṅ, teṅX, theṅ, deṅX, theṅX, deṅ` | all extracted forms lack an i-medial after the onset |
| `09-11` | 亭 | `teṅ` | `teṅ₂` | `a` | no | `deṅ` | all extracted forms lack an i-medial after the onset |
...
| `09-13` | 奠 | `tiṅ` | `tiṅ` | `mixed` | no | `deṅ, deṅH, denH, ḍieṅH, ḍiek` | the extracted forms point to both type a and type b |
| `09-13` | 鄭 | `tiṅ` | `tiṅ₂` | `b` | no | `ḍieṅH, ḍiek` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `09-24` | 觲 | `seṅ` | `seṅ` | `b` | no | `sieṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `09-29` | 屏 | `peṅ` | `peṅ₄` | `mixed` | no | `beṅ, pyieṅ, pyieṅH, pyieṅX, byieṅH` | the extracted forms point to both type a and type b |
| `09-30` | 冥 | `meṅ` | `meṅ` | `a` | no | `meṅ, meṅX, men, menH, mek` | all extracted forms lack an i-medial after the onset |
...
| `11-06` | 屋 | `q\textoverset{a}{o}k\textsuperscript{·cella}` | `q\textoverset{a}{o}k\textsuperscript{·cella}` | `a` | no | `quwk, qaewk, quwH` | all extracted forms lack an i-medial after the onset |
...
| `11-24` | 沐 | `\textsuperscript{aq·}m\textoverset{a}{o}k` | `\textsuperscript{aq·}m\textoverset{a}{o}k` | `a` | no | `muwk` | all extracted forms lack an i-medial after the onset |
...
| `12-05` | 匈 | `\textsuperscript{flect·}q\textoverset{b}{o}ṅ` | `\textsuperscript{flect·}q\textoverset{b}{o}ṅ` | `b` | no | `hiəwṅ, hiəwṅX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `12-08` | 動 | `toṅ` | `t\textoverset{a}{o}ṅ` | `a` | yes | `duwṅX, duwṅH` | all extracted forms lack an i-medial after the onset |
| `12-08` | 童 | `toṅ` | `toṅ₂` | `mixed` | no | `duwṅ, chiəwṅ, ḍaewṅH, jiəwṅX, ḍaewṅ, thuwṅ, ḍiəwṅ, ciəwṅX, ciəwṅ` | the extracted forms point to both type a and type b |
| `12-09` | 同 | `loṅ` | `l\textoverset{a}{o}ṅ` | `a` | yes | `duwṅ, duwṅH, duwṅX, thuwṅ, thuwṅH` | all extracted forms lack an i-medial after the onset |
| `12-10` | 用 | `loṅ` | `loṅ` | `mixed` | no | `yiəwṅH, yiəwṅX, ziəwṅH, thuwṅX, thuwṅH, thuwṅ, duwṅ` | the extracted forms point to both type a and type b |
...
| `12-20` | 㚇 | `s\textoverset{a}{o}ṅ₅` | `s\textoverset{a}{o}ṅ₅` | `a` | no | `tsuwṅ, tsuwṅH` | all extracted forms lack an i-medial after the onset |
...
| `12-25` | 封 | `poṅ` | `poṅ₂` | `mixed` | no | `piəwṅ, phiəwṅ, paewṅX, puwṅX` | the extracted forms point to both type a and type b |
...
| `13-01` | 皐 | `ku₄` | `ku₆` | `a` | no | `kaw, ḫaw, ḫawX, ṅaw` | all extracted forms lack an i-medial after the onset |
| `13-01` | 皋 | `ku₄` | `ku₅` | `a` | no | `kaw, ḫaw, ḫawX, ṅaw` | all extracted forms lack an i-medial after the onset |
| `13-01` | 噑 | `ku₄` | `ku₇` | `a` | no | `ḫaw, ḫawX` | all extracted forms lack an i-medial after the onset |
...
| `13-06` | 韭 | `ku` | `ku` | `b` | no | `kiuwX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `13-19` | 舟 | `tu` | `tu` | `b` | no | `ciuw, ṭiuw` | all extracted forms show an i-medial or a dedicated palatal onset |
| `13-19` | 受 | `tu` | `tu₂` | `b` | no | `jiuwX, jiuwH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `13-20` | 州 | `tu` | `tu` | `b` | no | `ciuw, jiuw` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `13-47` | 桺 | `mu` | `mu₂` | `b` | no | `liuwX, liuw` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `16-01` | 槀 | `k\textoverset{a}{a}w\textsuperscript{˸arb}` | `k\textoverset{a}{a}w\textsuperscript{˸arb}` | `a` | no | `kawX, khawX` | all extracted forms lack an i-medial after the onset |
| `16-01` | 豪 | `kaw` | `k\textoverset{a}{a}w₂` | `a` | yes | `ḫaw` | all extracted forms lack an i-medial after the onset |
| `16-01` | 蒿 | `\textsuperscript{herb˸}k\textoverset{a}{a}w` | `\textsuperscript{herb˸}k\textoverset{a}{a}w` | `a` | no | `haw, khawX, haew, haewH` | all extracted forms lack an i-medial after the onset |
| `16-02` | 羔 | `ku₁₅` | `ku₁₅` | `mixed` | no | `kaw, kəwk, ciak` | the extracted forms point to both type a and type b |
| `16-03` | 喬 | `kaw` | `k\textoverset{b}{a}w` | `b` | yes | `giew, khiew, kiew, giewH, kiewH, kiewX, xiew, giak, kiak` | all extracted forms show an i-medial or a dedicated palatal onset |
| `16-06` | 交 | `kaw` | `k\textoverset{a}{a}w` | `a` | yes | `kaew, qewH, kaewk, kaewX, haew, qaew, ṅaewX, kaewH, ḫaew, ḫaewH, ḫaewX, khaew, kewX, qew` | all extracted forms lack an i-medial after the onset |
...
| `16-21` | 繇 | `l\textoverset{b}{a}w\textsuperscript{·lig}` | `l\textoverset{b}{a}w\textsuperscript{·lig}` | `b` | no | `ḍiuwH, yiew, yuw` | all extracted forms show an i-medial or a dedicated palatal onset |
| `16-24` | 尞 | `rew` | `rew₂` | `mixed` | no | `liewH, liew, lewH, lewX, liewX, lew, lawX, law` | the extracted forms point to both type a and type b |
| `16-27` | 𧴪 | `` | `` | `unknown` | no | `` |  |
| `16-28` | 羔 | `ku₁₇` | `ku₁₇` | `mixed` | no | `kaw, kəwk, ciak` | the extracted forms point to both type a and type b |
| `16-29` | 羔 | `ku₁₈` | `ku₁₈` | `mixed` | no | `kaw, kəwk, ciak` | the extracted forms point to both type a and type b |
| `16-30` | 喿 | `saw` | `s\textoverset{a}{a}w` | `a` | yes | `sawH, sawX, saw, tsawX, tsawH, tshawX, tshawH` | all extracted forms lack an i-medial after the onset |
...
| `16-32` | 巢 | `tsaw` | `tsaw` | `mixed` | no | `dẓaew, tsiewX, tṣhaew, saw, swaX, tsjewX` | the extracted forms point to both type a and type b |
...
| `16-40` | 麃 | `pew₅` | `pew₅` | `mixed` | no | `baew, piew, phiewX` | the extracted forms point to both type a and type b |
| `16-41` | 毛 | `maw` | `m\textoverset{a}{a}w` | `a` | yes | `maw, mawH, maewk, mak, hawH` | all extracted forms lack an i-medial after the onset |
| `16-42` | 皃 | `mek` | `mek` | `a` | no | `maewH, maewk` | all extracted forms lack an i-medial after the onset |
| `16-42` | 貌 | `mek` | `mek₄` | `a` | no | `maewH, maewk` | all extracted forms lack an i-medial after the onset |
| `16-43` | 苗 | `maw` | `maw` | `mixed` | no | `miew, miewH, maew` | the extracted forms point to both type a and type b |
| `16-44` | 眇 | `mew` | `mew₃` | `b` | no | `myiewX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `16-44` | 杪 | `mew` | `mew₂` | `b` | no | `myiewX, myiewH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `17-01` | 隺 | `kak` | `k\textoverset{a}{a}k` | `a` | yes | `həwk, haewk, hak, kaewk, khaewk` | all extracted forms lack an i-medial after the onset |
| `17-02` | 虐 | `ŋak` | `ŋ\textoverset{b}{a}k` | `b` | yes | `ṅiak, xiak` | all extracted forms show an i-medial or a dedicated palatal onset |
| `17-03` | 弔 | `tek` | `tek` | `mixed` | no | `tek, tewH, ciew` | the extracted forms point to both type a and type b |
| `17-05` | 勺 | `qek` | `qek` | `mixed` | no | `jiak, ciak, yak, tek, tewH, qiak, qyiewH, qaewk` | the extracted forms point to both type a and type b |
...
| `20-02` | 介 | `kep` | `kep` | `a` | no | `keayH, keat, ḫeayH, heayH, kaeyH, keyH` | all extracted forms lack an i-medial after the onset |
| `20-03` | 夬 | `kuet` | `kuet` | `mixed` | no | `kwaeyH, kwet, hwet, myieyH, khyiwet, khwet, hyiwet, qwet, khwaeyH` | the extracted forms point to both type a and type b |
| `20-07` | 臬 | `ṅet` | `ṅet` | `mixed` | no | `ṅet, ṅiet, ṅieyH` | the extracted forms point to both type a and type b |
| `20-09` | 屑 | `ṅet₄` | `ṅet₅` | `a` | no | `set` | all extracted forms lack an i-medial after the onset |
...
| `21-09` | 歺 | `ṅ\textoverset{a}{a}t` | `ṅ\textoverset{a}{a}t` | `a` | no | `ṅat` | all extracted forms lack an i-medial after the onset |
...
| `21-24` | 賴 | `ra` | `r\textoverset{a}{a}` | `a` | yes | `layH, lat, that, ṭhaet, lanX` | all extracted forms lack an i-medial after the onset |
| `21-25` | 列 | `ret` | `ret` | `b` | no | `liet, lieyH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `22-02` | 厥 | `kot` | `k\textoverset{b}{o}t₂` | `b` | yes | `kiwət, giwət, kiweyH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `22-07` | 𥄗 | `q\textoverset{a}{o}t` | `q\textoverset{a}{o}t` | `a` | no | `qwat, qwanH` | all extracted forms lack an i-medial after the onset |
...
| `23-12` | 敻 | `q\textoverset{a}{o}n` | `q\textoverset{a}{o}n₂` | `mixed` | no | `hyiweṅH, hwenH, gyiweṅ` | the extracted forms point to both type a and type b |
...
| `23-21` | 鮮 | `ser` | `ser` | `b` | no | `sien, sienX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `23-25` | 便 | `pen` | `pen` | `b` | no | `byien, byienH, byienX, bienH, pyien` | all extracted forms show an i-medial or a dedicated palatal onset |
| `23-26` | 臱 | `men` | `men` | `mixed` | no | `myien, pen, pyien` | the extracted forms point to both type a and type b |
| `23-26` | 邊 | `men` | `men₂` | `mixed` | no | `pen, pyien` | the extracted forms point to both type a and type b |
...
| `23-29` | 緜 | `men₃` | `men₄` | `b` | no | `myien` | all extracted forms show an i-medial or a dedicated palatal onset |
| `23-31` | 面 | `men` | `men` | `b` | no | `myienH, myienX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `23-32` | 丏 | `men` | `men` | `mixed` | no | `menX, menH, myienX` | the extracted forms point to both type a and type b |
...
| `24-11` | 晏 | `ʔan` | `ʔ\textoverset{a}{a}n₂` | `a` | yes | `qaenH, qanH, qenH` | all extracted forms lack an i-medial after the onset |
| `24-12` | 妟 | `qen` | `qen` | `mixed` | no | `qaenH, qenH, qiənH, qiənX, qenX, qaet` | the extracted forms point to both type a and type b |
| `24-12` | 匽 | `qen` | `qen₃` | `mixed` | no | `qiənH, qiənX, qenX, qaet` | the extracted forms point to both type a and type b |
| `24-14` | 焉 | `ʔan` | `ʔ\textoverset{b}{a}n` | `b` | yes | `qien, hien` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-15` | 厂 | `ṅar` | `ṅ\textoverset{a}{a}r` | `a` | yes | `hanH, ṅaenH` | all extracted forms lack an i-medial after the onset |
| `24-16` | 言 | `ṅan` | `ṅ\textoverset{b}{a}n` | `b` | yes | `ṅiɨn, ṅiən, ṅienH, ṅin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-17` | 鬳 | `ṅar` | `ṅar` | `mixed` | no | `ṅiənH, ṅienH, ṅiən, hiənH, ṅienX, ṅiənX, ṅiet, ṅat` | the extracted forms point to both type a and type b |
| `24-17` | 獻 | `ṅar` | `ṅar₂` | `mixed` | no | `hiənH, ṅienX, ṅiənX, ṅienH, ṅiet, ṅat` | the extracted forms point to both type a and type b |
| `24-18` | 憲 | `\textsuperscript{cor˸}q\textoverset{b}{a}n` | `\textsuperscript{cor˸}q\textoverset{b}{a}n` | `b` | no | `hiənH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-19` | 彥 | `ṅen` | `ṅen` | `mixed` | no | `ṅienH, ṅaen` | the extracted forms point to both type a and type b |
| `24-20` | 丹 | `tan` | `tan` | `mixed` | no | `tan, cien` | the extracted forms point to both type a and type b |
| `24-21` | 單 | `tar` | `tar` | `mixed` | no | `tan, tanX, jienX, jienH, cie, cieH, da, dan, ten, taH, than, chienX, danH, ṭhean, cienH, cienX, jien` | the extracted forms point to both type a and type b |
| `24-22` | 旦 | `tan` | `t\textoverset{a}{a}n` | `a` | yes | `tanH, thanX, danX, tat` | all extracted forms lack an i-medial after the onset |
| `24-23` | 亶 | `tan` | `tan` | `mixed` | no | `tanX, jien, thanX, dan, danH, danX, ṭienH, ṭienX, cienX, ḍienX, ṭien, cien, jienH, jienX, śien` | the extracted forms point to both type a and type b |
| `24-25` | 善 | `gen` | `gen` | `b` | no | `jienX, jienH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-26` | 展 | `ten` | `ten` | `b` | no | `ṭienH, ṭienX, ṇienX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-28` | 廛 | `tran` | `tr\textoverset{b}{a}n` | `b` | yes | `ḍien` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-29` | 衍 | `qan` | `q\textoverset{b}{a}n` | `b` | yes | `yienH, yienX, khien` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-30` | 延 | `lan` | `lan` | `mixed` | no | `yien, yan, ṭhien, śien, danX` | the extracted forms point to both type a and type b |
...
| `24-39` | 賛 | `ts\textoverset{a}{a}r` | `ts\textoverset{a}{a}r₂` | `a` | no | `tsanH, dzanX, dzwan` | all extracted forms lack an i-medial after the onset |
...
| `24-48` | 般 | `pan` | `p\textoverset{a}{a}n` | `a` | yes | `ban, pan` | all extracted forms lack an i-medial after the onset |
| `24-49` | 反 | `pan` | `pan` | `mixed` | no | `piənX, piənH, baenX, biənH, biənX, paenX, paen` | the extracted forms point to both type a and type b |
| `24-50` | 棥 | `pan₃` | `pan₃` | `mixed` | no | `biən, phaen` | the extracted forms point to both type a and type b |
| `24-50` | 樊 | `pan₃` | `pan₄` | `mixed` | no | `biən, phaen` | the extracted forms point to both type a and type b |
| `24-51` | 煩 | `pan` | `p\textoverset{b}{a}n` | `b` | yes | `biən` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-52` | 繁 | `pan` | `pan₆` | `mixed` | no | `ban, biən` | the extracted forms point to both type a and type b |
...
| `24-54` | 番 | `par` | `par` | `mixed` | no | `pa, phiən, piən, biən, phan, ban, paH, ba` | the extracted forms point to both type a and type b |
| `24-54` | 潘 | `par` | `par₂` | `mixed` | no | `phan, piən` | the extracted forms point to both type a and type b |
| `24-55` | 弁 | `pon` | `p\textoverset{b}{o}n` | `b` | yes | `bienH, phiən, piunH, biən` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-55` | 卞 | `pon` | `p\textoverset{b}{o}n₂` | `b` | yes | `bienH, phiən` | all extracted forms show an i-medial or a dedicated palatal onset |
| `24-56` | 曼 | `man` | `man` | `mixed` | no | `manH, miənH, maenH, man, mien` | the extracted forms point to both type a and type b |
| `24-57` | 㒼 | `man` | `man` | `mixed` | no | `man, manX, mwənH, mwənX, manH, miən, mwən` | the extracted forms point to both type a and type b |
| `24-57` | 滿 | `man₃` | `m\textoverset{a}{a}n` | `a` | yes | `manX, mwənH, mwənX` | all extracted forms lack an i-medial after the onset |
| `24-58` | 免 | `mor` | `mor` | `mixed` | no | `mienX, miunH, man, mwənX, miənX, mwəyX` | the extracted forms point to both type a and type b |
| `25-01` | 官 | `kuan` | `ku\textoverset{a}{a}n` | `a` | yes | `kwan, kwanH, kwanX, kwaenH, hwanH, kaen` | all extracted forms lack an i-medial after the onset |
| `25-02` | 雚 | `quar` | `quar` | `mixed` | no | `kwanH, kwan, hwan, hwanH, giwen, khiwənH` | the extracted forms point to both type a and type b |
| `25-03` | 貫 | `kon` | `k\textoverset{a}{o}n` | `a` | yes | `kwaenH, kwan, kwanH` | all extracted forms lack an i-medial after the onset |
| `25-03` | 串 | `kon` | `k\textoverset{a}{o}n₂` | `a` | yes | `kwaenH, hwaenH` | all extracted forms lack an i-medial after the onset |
| `25-07` | 萈 | `ɡon` | `ɡ\textoverset{a}{o}n` | `a` | yes | `ḫwan, khwan` | all extracted forms lack an i-medial after the onset |
| `25-11` | 卷 | `kuen` | `kuen` | `b` | no | `giwen, kiwenX, kiwenH, khiwen, giwenH, giwenX, giwənH, khiwənX, kiwənX, khiwənH, qiwənX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `25-11` | 豢 | `kuen₂` | `kuen₃` | `a` | no | `ḫwaenH, ḫwanH` | all extracted forms lack an i-medial after the onset |
| `25-12` | 亘 | `quar` | `quar` | `mixed` | no | `hwan, kəṅH, siwen, ḫwan, hiwən, ḫiwən, hiwənX, hiweX` | the extracted forms point to both type a and type b |
...
| `25-13` | 奐 | `qon` | `q\textoverset{a}{o}n` | `a` | yes | `hwanH, ḫwan, ḫwanH` | all extracted forms lack an i-medial after the onset |
| `25-13` | 敻 | `q\textoverset{a}{o}n₃` | `q\textoverset{a}{o}n₄` | `mixed` | no | `hyiweṅH, hwenH, gyiweṅ` | the extracted forms point to both type a and type b |
| `25-14` | 爰 | `quan` | `quan` | `mixed` | no | `ḫiwən, ḫiwenH, ḫiwənH, ḫiwen, hiwən, hiwənX, ḫwanX, ḫwaen` | the extracted forms point to both type a and type b |
| `25-15` | 袁 | `gan` | `g\textoverset{b}{a}n` | `b` | yes | `ḫiwən, ḫiwen, ḫiwənH, ḫiwənX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `25-16` | 丸 | `quar` | `quar` | `mixed` | no | `hwan, hwanH, qiweX` | the extracted forms point to both type a and type b |
| `25-17` | 宛 | `qor` | `qor₂` | `mixed` | no | `qiwənX, qwanH, qwanX` | the extracted forms point to both type a and type b |
...
| `25-31` | 䜌 | `ron` | `ron` | `mixed` | no | `lwan, liwenX, liwenH, liwen, pienH, maen, ṣiwenH, ṣwaenH` | the extracted forms point to both type a and type b |
| `25-33` | 𤔔 | `ron` | `r\textoverset{a}{o}n` | `a` | yes | `lwanH` | all extracted forms lack an i-medial after the onset |
| `25-35` | 耎 | `non` | `non` | `mixed` | no | `ñiwenX, ñiwen, nwanH, nwanX, ñiwet` | the extracted forms point to both type a and type b |
| `25-38` | 全 | `tson` | `ts\textoverset{b}{o}n` | `b` | yes | `dziwen, tshiwen, jiwen` | all extracted forms show an i-medial or a dedicated palatal onset |
| `25-39` | 雋 | `s\textoverset{b}{o}n` | `s\textoverset{b}{o}n` | `b` | no | `dziwenX, tsiwenX, tsiwen, tswinH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `25-40` | 泉 | `qua` | `qu\textoverset{b}{a}` | `b` | yes | `dziwen, sienH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `25-43` | 算 | `s\textoverset{a}{o}n` | `s\textoverset{a}{o}n` | `a` | no | `swanH, swanX` | all extracted forms lack an i-medial after the onset |
| `25-44` | 祘 | `s\textoverset{a}{o}n₂` | `s\textoverset{a}{o}n₂` | `a` | no | `swanH` | all extracted forms lack an i-medial after the onset |
...
| `26-06` | 耆 | `kiy` | `kiy₅` | `b` | no | `giy, ciyX, jiyH, śiy` | all extracted forms show an i-medial or a dedicated palatal onset |
| `26-08` | 几 | `kry` | `kry` | `b` | no | `kiyX, kiy` | all extracted forms show an i-medial or a dedicated palatal onset |
| `26-09` | 皆 | `kiy` | `kiy` | `a` | no | `keay, kheayX, heay, keat` | all extracted forms lack an i-medial after the onset |
| `26-10` | 癸 | `kuiy` | `kuiy` | `mixed` | no | `kiwiyX, giwiyX, gwiy, giwiy, khwey, khwet` | the extracted forms point to both type a and type b |
| `26-12` | 医 | `qi` | `qi` | `a` | no | `qeyH, qey` | all extracted forms lack an i-medial after the onset |
| `26-12` | 殹 | `qi` | `qi₂` | `a` | no | `qeyH, qey` | all extracted forms lack an i-medial after the onset |
| `26-13` | 伊 | `qiy` | `qiy` | `b` | no | `qyiy` | all extracted forms show an i-medial or a dedicated palatal onset |
| `26-14` | 氐 | `tiy` | `tiy` | `mixed` | no | `tey, teyX, teyH, dey, ṭiy, ḍiy, ciyX, ciy, jiyH, jiyX, chiy` | the extracted forms point to both type a and type b |
| `26-15` | 弟 | `ly` | `ly` | `mixed` | no | `deyH, deyX, dey, they, theyH, theyX, ḍit` | the extracted forms point to both type a and type b |
| `26-16` | 屖 | `ly` | `ly` | `mixed` | no | `sey, ḍiy, ḍiyH` | the extracted forms point to both type a and type b |
| `26-16` | 犀 | `ly` | `ly₁₂` | `mixed` | no | `sey, ḍiy, ḍiyH` | the extracted forms point to both type a and type b |
| `26-17` | 夷 | `ly` | `ly` | `mixed` | no | `yiy, theyH, dey` | the extracted forms point to both type a and type b |
| `26-19` | 矢 | `liy` | `liy` | `mixed` | no | `śiy, śiyX, ḍiyX, theyH, ziyX, śinX, śiwinH` | the extracted forms point to both type a and type b |
| `26-19` | 雉 | `liy` | `liy₂` | `mixed` | no | `ḍiyX, theyH, ziyX` | the extracted forms point to both type a and type b |
| `26-20` | 尸 | `ly` | `ly` | `b` | no | `śiy, syijX, xjij` | all extracted forms show an i-medial or a dedicated palatal onset |
| `26-23` | 豊 | `riy` | `riy` | `a` | no | `leyX, ṭheyX` | all extracted forms lack an i-medial after the onset |
| `26-24` | 利 | `rit` | `rit` | `mixed` | no | `liyH, liy, ley` | the extracted forms point to both type a and type b |
| `26-24` | 𥝢 | `rit` | `rit₂` | `mixed` | no | `liyH, liy, ley` | the extracted forms point to both type a and type b |
| `26-24` | 黎 | `rit` | `rit₃` | `mixed` | no | `ley, liy` | the extracted forms point to both type a and type b |
| `26-25` | 尼 | `ni` | `ni` | `mixed` | no | `neyH, ṇiy, ṇiyH, ṇiyX, ney, ṇieX, ṇit` | the extracted forms point to both type a and type b |
| `26-26` | 妻 | `tsy` | `tsy` | `a` | no | `tshey, tsheyH, tsey, tseyH, sey` | all extracted forms lack an i-medial after the onset |
| `26-27` | 齊 | `tsy` | `tsy` | `mixed` | no | `dzey, tsiy, dzeyH, dzeyX, tseyH, tsey, tseyX, tṣeay, dẓeay` | the extracted forms point to both type a and type b |
| `26-28` | 姊 | `sy₆` | `sy₆` | `mixed` | no | `tsiyX, tsey` | the extracted forms point to both type a and type b |
...
| `26-37` | 匕 | `piy` | `piy` | `b` | no | `pyiyX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `26-38` | 坒 | `piy` | `piy₄` | `mixed` | no | `byiyH, beyX` | the extracted forms point to both type a and type b |
| `26-39` | 米 | `miy` | `miy` | `mixed` | no | `meyX, mey, miy, myieX, myie` | the extracted forms point to both type a and type b |
| `26-39` | 麋 | `miy` | `miy₂` | `b` | no | `miy` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-02` | 豈 | `qy` | `qy` | `mixed` | no | `khiɨyX, khəyX, khəyH, khəy, həy, ṅiɨyX, kiyH` | the extracted forms point to both type a and type b |
| `27-03` | 冀 | `kyk` | `kyk` | `b` | no | `kiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-04` | 幾 | `ky` | `ky` | `b` | no | `giɨy, kiɨy, kiɨyX, kiɨyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-05` | 衣 | `ʔy` | `ʔy` | `b` | no | `qiɨy, qiɨyH, qiɨyX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-05` | 哀 | `qy` | `qy₁₃` | `mixed` | no | `qəy, qiɨyX` | the extracted forms point to both type a and type b |
...
| `27-14` | 眉 | `myr` | `myr` | `b` | no | `miy, miɨyX, miyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-17` | 尾 | `my` | `my` | `b` | no | `miɨyX, hiwɨyX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-18` | 微 | `my` | `my₇` | `b` | no | `miɨy, miyX, hiwɨy` | all extracted forms show an i-medial or a dedicated palatal onset |
| `27-20` | 蟲 | `luṅ` | `luṅ₆` | `mixed` | no | `ḍiuwṅ, dəwṅ` | the extracted forms point to both type a and type b |
| `27-20` | 虫 | `luṅ` | `luṅ₅` | `mixed` | no | `ḍiuwṅ, dəwṅ, yuwṅ` | the extracted forms point to both type a and type b |
...
| `28-02` | 歸 | `kuy` | `kuy` | `b` | no | `kiwɨy, khwiy, khwiyX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `28-20` | 辠 | `tsuy` | `tsuy₃` | `a` | no | `dzwəyX` | all extracted forms lack an i-medial after the onset |
...
| `29-06` | 穴 | `quit` | `quit` | `mixed` | no | `ḫwet, hwet, yiwit` | the extracted forms point to both type a and type b |
| `29-07` | 血 | `mik` | `mik` | `mixed` | no | `hwet, swit, swət` | the extracted forms point to both type a and type b |
| `29-08` | 惠 | `quiy` | `quiy₅` | `mixed` | no | `hweyH, zwiyH, siweyH` | the extracted forms point to both type a and type b |
| `29-08` | 叀 | `quiy` | `quiy₄` | `mixed` | no | `hweyH, zwiyH, siweyH` | the extracted forms point to both type a and type b |
| `29-09` | 㒸 | `sut` | `sut` | `mixed` | no | `zwiyH, swiyH, ḍwiyH, dwəyH` | the extracted forms point to both type a and type b |
| `29-09` | 遂 | `sut` | `sut₂` | `b` | no | `zwiyH, swiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-09` | 隊 | `lut` | `lut` | `mixed` | no | `ḍwiyH, dwəyH` | the extracted forms point to both type a and type b |
| `29-10` | 彗 | `quet` | `quet` | `mixed` | no | `ziweyH, zwiyH, xweyH, hweyH` | the extracted forms point to both type a and type b |
| `29-10` | 慧 | `quet` | `quet₂` | `a` | no | `hweyH` | all extracted forms lack an i-medial after the onset |
| `29-11` | 矞 | `qut` | `qut` | `mixed` | no | `yiwit, kiwit, giwit, kweat, kwet, xwet, hwiyH` | the extracted forms point to both type a and type b |
| `29-13` | 壹 | `ʔit` | `ʔit` | `mixed` | no | `qyit, qet, qiyH, qeyH` | the extracted forms point to both type a and type b |
| `29-15` | 至 | `tit` | `tit` | `mixed` | no | `ciyH, ṭiyH, ṭit, det, tet, cit, śit, ḍit` | the extracted forms point to both type a and type b |
| `29-16` | 疐 | `lit` | `lit` | `mixed` | no | `teyH, ṭiyH, ṭhiyH, ciyH` | the extracted forms point to both type a and type b |
| `29-17` | 失 | `lit` | `lit` | `mixed` | no | `śit, yit, det, ṭhit, ḍit` | the extracted forms point to both type a and type b |
| `29-23` | 栗 | `rit` | `rit` | `b` | no | `lit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-25` | 戾 | `ret` | `ret` | `mixed` | no | `leyH, let, lwiyH` | the extracted forms point to both type a and type b |
| `29-26` | 日 | `nit` | `nit` | `mixed` | no | `ñit, ṇit, net` | the extracted forms point to both type a and type b |
| `29-26` | 圼 | `nit` | `nit₂` | `a` | no | `net` | all extracted forms lack an i-medial after the onset |
| `29-28` | 二 | `niy` | `niy` | `b` | no | `ñiyH, ṇiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-28` | 弍 | `niy` | `niy₄` | `b` | no | `ñiyH, ṇiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-28` | 貳 | `niy` | `niy₅` | `b` | no | `ñiyH, ṇiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-29` | 疾 | `tsit` | `tsit` | `b` | no | `dzit, dziyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-30` | 節 | `tsik` | `tsik₅` | `mixed` | no | `dzet, tset, tṣit` | the extracted forms point to both type a and type b |
| `29-30` | 即 | `tsik` | `tsik₄` | `mixed` | no | `tsik, tṣit, dzet, tset, tsit, tsiek` | the extracted forms point to both type a and type b |
| `29-30` | 卪 | `tsik` | `tsik₆` | `mixed` | no | `tset, tsik, tsit` | the extracted forms point to both type a and type b |
| `29-31` | 七 | `tshit` | `tshit` | `mixed` | no | `tshit, tshet` | the extracted forms point to both type a and type b |
| `29-32` | 桼 | `tsit` | `tsit` | `b` | no | `tshit, sit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-33` | 悉 | `qik` | `qik₄` | `b` | no | `sit, ṣit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-34` | 四 | `siy` | `siy` | `b` | no | `siyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-39` | 畀 | `pik` | `pik` | `mixed` | no | `pyiyH, byiyH, pheyH, phyieyH` | the extracted forms point to both type a and type b |
| `29-41` | 必 | `pit` | `pit` | `mixed` | no | `pyit, bit, bet, byit, piyH, pit, mit, myit, bjit` | the extracted forms point to both type a and type b |
| `29-41` | 宓 | `mit` | `mit` | `b` | no | `mit, myit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-41` | 𥁑 | `mit` | `mit₂` | `b` | no | `myit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `29-42` | 畢 | `pit` | `pit` | `b` | no | `pyit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-01` | 气 | `qyp` | `qyp` | `b` | no | `khiɨyH, xiɨyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-01` | 氣 | `qyp` | `qyp₂` | `b` | no | `khiɨyH, xiɨyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-01` | 乞 | `qyp` | `qyp₃` | `mixed` | no | `khiɨt, kiɨt, xiɨyH, xiɨt, ṅiɨt, het, hət, kiɨyH` | the extracted forms point to both type a and type b |
| `30-02` | 旡 | `kyt` | `kyt` | `mixed` | no | `kiɨyH, giyH, xiyH, xiɨyH, kəyH, khəyH` | the extracted forms point to both type a and type b |
| `30-02` | 既 | `kyt` | `kyt₂` | `mixed` | no | `kiɨyH, giyH, xiyH, xiɨyH, kəyH, khəyH` | the extracted forms point to both type a and type b |
| `30-06` | 愛 | `qyp` | `qyp` | `mixed` | no | `qəyH, qiɨyX` | the extracted forms point to both type a and type b |
| `30-09` | 豙 | `ŋyt` | `ŋyt` | `b` | no | `ṅiɨyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-09` | 毅 | `ṅyt` | `ṅyt₂` | `b` | no | `ṅiɨyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-10` | 質 | `lit` | `lit` | `b` | no | `ṭiyH, cit, ṭhiyH, ciyH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `30-11` | 隶 | `ryp` | `ryp` | `mixed` | no | `dəyH, yiyH, deyH, thəyH, siyH` | the extracted forms point to both type a and type b |
| `30-11` | 逮 | `ryp` | `ryp₂` | `a` | no | `deyH, dəyH, thəyH` | all extracted forms lack an i-medial after the onset |
| `30-11` | 肆 | `ryp` | `ryp₃` | `b` | no | `siyH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `31-02` | 匱 | `gruy` | `gruy` | `b` | no | `gwiyH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `31-14` | 對 | `typ` | `typ` | `mixed` | no | `twəyH, ṭwiyH, ḍwiyH` | the extracted forms point to both type a and type b |
...
| `31-18` | 聿 | `rut` | `rut` | `b` | no | `yiwit, lwit, pit` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `31-23` | 率 | `rut` | `rut` | `b` | no | `lwiyH, lwit, ṣwiyH, ṣwit, swrit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `32-01` | 臤 | `kin` | `kin₃` | `mixed` | no | `ḫen, khanH, khean, kheaṅ, khyinH, ken, khen, ḫenH, kyinX, jinX` | the extracted forms point to both type a and type b |
...
| `32-04` | 犬 | `kuen` | `kuen` | `a` | no | `khwenX, kwenX` | all extracted forms lack an i-medial after the onset |
| `32-05` | 玄 | `gin` | `gin` | `a` | no | `ḫwen, ḫwenX, ḫwenH, ḫen, hwenH, kwənX` | all extracted forms lack an i-medial after the onset |
| `32-05` | 弦 | `gin` | `gin` | `a` | no | `ḫen` | all extracted forms lack an i-medial after the onset |
| `32-07` | 均 | `quin` | `quin₂` | `b` | no | `kiwin, ḫiwin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `32-07` | 䀏 | `quiṅ` | `quiṅ₂` | `mixed` | no | `ḫwen, ywin, kiwin, ḫiwin` | the extracted forms point to both type a and type b |
| `32-07` | 匀 | `quiṅ` | `quiṅ₃` | `mixed` | no | `ywin, kiwin, ḫiwin, ḫwen` | the extracted forms point to both type a and type b |
| `32-08` | 旬 | `sin` | `sin` | `mixed` | no | `zwin, zwinH, swin, swinH, hwen, śiwinH, hwenH, swinX, ṭhwin` | the extracted forms point to both type a and type b |
| `32-08` | 筍 | `quin` | `quin₄` | `b` | no | `swinX, swin, ṭhwin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `32-09` | 因 | `ʔin` | `ʔin` | `mixed` | no | `qyin, qin, qen, qenH, qwen, qən` | the extracted forms point to both type a and type b |
| `32-10` | 垔 | `qin` | `qin` | `mixed` | no | `qin, qyin, qen` | the extracted forms point to both type a and type b |
| `32-12` | 淵 | `ʔin` | `ʔin` | `mixed` | no | `qwen, qyin` | the extracted forms point to both type a and type b |
...
| `32-28` | 千 | `niṅ` | `niṅ₃` | `a` | no | `tshen` | all extracted forms lack an i-medial after the onset |
| `32-29` | 晉 | `tsin` | `tsin` | `b` | no | `tsinH, tsinX` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `32-40` | 昏 | `miṅ` | `miṅ₂` | `mixed` | no | `hwən, menX, mwən, min, minX` | the extracted forms point to both type a and type b |
| `33-01` | 艮 | `kyn` | `kyn` | `mixed` | no | `kənH, kən, khənX, ḫənX, ḫənH, ḫən, ṅiɨn, ḫeanX, ṅin, ṅeanX, ṅənX` | the extracted forms point to both type a and type b |
| `33-02` | 斤 | `kyr` | `kyr` | `mixed` | no | `kiɨn, kiɨnH, giɨn, giɨnH, giɨnX, hiɨn, hiɨnH, hiən, giɨy, ṅiɨn, khənX` | the extracted forms point to both type a and type b |
| `33-02` | 欣 | `kyr` | `kyr₂` | `b` | no | `hiɨn, hiɨnH, hiən` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-05` | 堇 | `kyr` | `kyr₄` | `mixed` | no | `gin, kean, ginH, kiɨnH, kiɨnX, giɨn, khinH, khinX` | the extracted forms point to both type a and type b |
| `33-05` | 勤 | `gyr` | `gyr` | `b` | no | `giɨn` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-09` | 殷 | `ʔyr` | `ʔyr` | `mixed` | no | `qean, qiɨn, qiɨnX` | the extracted forms point to both type a and type b |
| `33-10` | 隱 | `ʔyn` | `ʔyn` | `b` | no | `qiɨnH, qiɨnX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-11` | 典 | `tyr` | `tyr` | `a` | no | `tenX, thenX` | all extracted forms lack an i-medial after the onset |
| `33-12` | 殿 | `tyn` | `tyn₅` | `a` | no | `denH, tenH, dwən` | all extracted forms lack an i-medial after the onset |
| `33-13` | 辰 | `tyr` | `tyr` | `b` | no | `jin, jinX, cinH, cin, śin, ṭhiy, ṭhinX, źiwin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-13` | 脣 | `tyr` | `tyr₂` | `b` | no | `źiwin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-15` | 㐱 | `tyn` | `tyn` | `mixed` | no | `cinX, cin, cinH, ḍienX, jienX, ṭienX, ṭin, ṭhinH, denX, thet, ḍinH, nenX` | the extracted forms point to both type a and type b |
| `33-15` | 殄 | `tyn` | `tyn₃` | `a` | no | `denX, thet` | all extracted forms lack an i-medial after the onset |
| `33-19` | 寅 | `qyr` | `qyr` | `b` | no | `yiy, yin, yinX, yienX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-20` | 刃 | `nyn` | `nyn` | `b` | no | `ñinH, ñinX, ṇin, ñin, nrit` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-20` | 忍 | `nyn` | `nyn₂` | `b` | no | `ñinX, ñinH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `33-22` | 存 | `tsyn` | `tsyn` | `a` | no | `dzwən, dzenH, dzwənH` | all extracted forms lack an i-medial after the onset |
| `33-25` | 先 | `syr` | `syr` | `mixed` | no | `sen, senH, senX, seyX, ṣin` | the extracted forms point to both type a and type b |
| `33-28` | 奔 | `pur` | `pur` | `mixed` | no | `pwən, piun` | the extracted forms point to both type a and type b |
| `33-29` | 賁 | `pur` | `pur` | `mixed` | no | `biun, pieH, pwən, phwən, phwənH, bwənH, piun, piunH, biunX, phiun` | the extracted forms point to both type a and type b |
| `33-30` | 分 | `pyn` | `pyn` | `mixed` | no | `biunH, piun, piunX, phiunH, phiunX, phiun, biunX, biun, paen, bwən, pin, bin, pheanH` | the extracted forms point to both type a and type b |
| `33-35` | 門 | `myn` | `myn` | `mixed` | no | `mwən, miun, miunH, min` | the extracted forms point to both type a and type b |
| `33-36` | 文 | `myn` | `myn` | `mixed` | no | `miun, miunH, miunX, mwən, min, minX, linH` | the extracted forms point to both type a and type b |
| `33-36` | 閔 | `myn` | `myn₃` | `b` | no | `minX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-01` | 昆 | `kun` | `kun` | `a` | no | `kwən, kwənX, hwənX` | all extracted forms lack an i-medial after the onset |
| `34-02` | 袞 | `kun₄` | `kun₅` | `a` | no | `kwənX` | all extracted forms lack an i-medial after the onset |
| `34-09` | 困 | `kun` | `kun` | `a` | no | `khwənH, khwənX` | all extracted forms lack an i-medial after the onset |
| `34-10` | 圂 | `ɡun` | `ɡun` | `a` | no | `ḫwənH` | all extracted forms lack an i-medial after the onset |
| `34-11` | 囷 | `kun` | `kun` | `b` | no | `khwin, gwinX, kwin, kiunH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-11` | 麕 | `kun₂` | `kun₃` | `b` | no | `kwin, kiunH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-12` | 君 | `qur` | `qur` | `b` | no | `kiun, giun, giunH, hiun, kwin, qwin, khwin, gwinX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-13` | 軍 | `kuyr` | `kuyr` | `mixed` | no | `kiun, hwən, hiunH, hiwənH, hiun, hiwɨy, hiwɨyH` | the extracted forms point to both type a and type b |
| `34-14` | 云 | `quyr` | `quyr` | `mixed` | no | `ḫiun, ḫiunH, ḫwən, ḫiunX` | the extracted forms point to both type a and type b |
| `34-14` | 雲 | `quyn` | `quyn` | `mixed` | no | `ḫiun, ḫiunH, ḫwən` | the extracted forms point to both type a and type b |
| `34-15` | 熏 | `qun` | `qun` | `b` | no | `hiun, hiwən` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `34-17` | 屯 | `tun` | `tun` | `mixed` | no | `dwən, ṭwin, dwənX, dwənH, twənH, ṭhwin, jiwin, ciwin, tsi, ciwinH, ciwinX` | the extracted forms point to both type a and type b |
...
| `34-19` | 春 | `tun` | `tun` | `b` | no | `chiwin, chiwinX, ṭhwin, śiwinH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-20` | 川 | `lun` | `lun` | `b` | no | `chiwen, ṭhwin, źiwinH, zwin, źiwin` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-21` | 盾 | `lun` | `lun` | `mixed` | no | `dwənX, źiwinX, jiwinX, zwin, źiwinH, ṭhwin, dwənH, dwət` | the extracted forms point to both type a and type b |
| `34-22` | 豚 | `lun` | `lun` | `a` | no | `dwən, dwənX, dwənH` | all extracted forms lack an i-medial after the onset |
| `34-23` | 允 | `lur` | `lur` | `b` | no | `yiwinX, źiwinX, yiwenX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `34-23` | 夋 | `lur` | `lur₂` | `mixed` | no | `tshwin, swinH, dzwən, tshiwen, swan, tswəyH, tswənH, tswəy, tswinH` | the extracted forms point to both type a and type b |
| `34-24` | 侖 | `run` | `run` | `mixed` | no | `lwin, lwən, lwənH, lwənX` | the extracted forms point to both type a and type b |
| `34-26` | 尊 | `tsun` | `tsun` | `mixed` | no | `tswən, tswənX, dzwən, tshwin, dzwənH, dzwənX, tswin` | the extracted forms point to both type a and type b |
| `34-27` | 寸 | `tshun` | `tshun` | `a` | no | `tshwənH, tshwənX` | all extracted forms lack an i-medial after the onset |
| `34-28` | 孫 | `sun` | `sun` | `a` | no | `swən, swənH` | all extracted forms lack an i-medial after the onset |
| `34-30` | 巽 | `sun` | `sun` | `mixed` | no | `swənH, swinX, tswin, siwenH, siwenX, dẓiwenX, dẓiwenH, tshiwen` | the extracted forms point to both type a and type b |
| `34-31` | 隼 | `sun₄` | `sun₄` | `b` | no | `swinX, ñiwinX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `35-02` | 甲 | `kap` | `k\textoverset{a}{a}p` | `a` | yes | `kaep, ḫaep, qaep` | all extracted forms lack an i-medial after the onset |
| `35-03` | 夾 | `kep` | `kep` | `a` | no | `keap, kep, heap, kaep, khep, hep, tsep` | all extracted forms lack an i-medial after the onset |
| `35-03` | 匧 | `kep` | `kep₄` | `a` | no | `khep` | all extracted forms lack an i-medial after the onset |
| `35-04` | 劦 | `ɡyp` | `ɡyp` | `mixed` | no | `hep, xiaep` | the extracted forms point to both type a and type b |
| `35-04` | 脅 | `ɡyp` | `ɡyp₂` | `b` | no | `xiaep` | all extracted forms show an i-medial or a dedicated palatal onset |
| `35-07` | 𦐇 | `tap` | `t\textoverset{a}{a}p` | `a` | yes | `thap, dap` | all extracted forms lack an i-medial after the onset |
| `35-10` | 枼 | `lep` | `lep` | `mixed` | no | `yiep, dep, sep, śiet, źiet, śiep` | the extracted forms point to both type a and type b |
| `35-12` | 巤 | `rap` | `rap` | `mixed` | no | `liep, lap` | the extracted forms point to both type a and type b |
| `35-13` | 聶 | `nep` | `nep` | `b` | no | `ṇiep, ciep, ñiep, śiep` | all extracted forms show an i-medial or a dedicated palatal onset |
| `35-15` | 妾 | `tsap` | `tsap` | `mixed` | no | `tshiep, tsiep, ṣaep` | the extracted forms point to both type a and type b |
| `35-16` | 疌 | `tsap` | `ts\textoverset{b}{a}p` | `b` | yes | `dziep, tsiep` | all extracted forms show an i-medial or a dedicated palatal onset |
| `35-17` | 臿 | `tsop` | `tsop` | `mixed` | no | `tṣheap, ṣeap, ṣiep` | the extracted forms point to both type a and type b |
| `35-20` | 乏 | `pop` | `pop` | `mixed` | no | `biəp, phiəmH, piemH, pəṅH, piaemX, piemX` | the extracted forms point to both type a and type b |
| `35-21` | 劫 | `kap` | `k\textoverset{b}{a}p₂` | `b` | yes | `kiaep` | all extracted forms show an i-medial or a dedicated palatal onset |
| `35-21` | 盍 | `kap` | `kap` | `mixed` | no | `hap, kiaep, khiaep, piəp, kayH, xaep, khap, khəp, khaeyH, hiep` | the extracted forms point to both type a and type b |
| `35-21` | 盇 | `k\textoverset{b}{a}p\textsuperscript{˸vas}` | `k\textoverset{b}{a}p\textsuperscript{˸vas}` | `a` | no | `hap, kayH` | all extracted forms lack an i-medial after the onset |
| `36-01` | 甘 | `kam` | `kam` | `mixed` | no | `kam, ham, giem, kəm, han` | the extracted forms point to both type a and type b |
| `36-01` | 拑 | `kam` | `k\textoverset{b}{a}m` | `b` | yes | `giem` | all extracted forms show an i-medial or a dedicated palatal onset |
| `36-02` | 敢 | `kam` | `kam` | `mixed` | no | `kamX, khamH, xaemX, xamX, xeamX, ngim, ṅiaem, ṅiaemX, ṅaem, xiemX` | the extracted forms point to both type a and type b |
| `36-02` | 闞 | `kam₂` | `k\textoverset{a}{a}m₃` | `a` | yes | `khamH, xaemX, xamX, xeamX` | all extracted forms lack an i-medial after the onset |
...
| `36-05` | 㯺 | `k\textoverset{a}{a}m` | `k\textoverset{a}{a}m₂` | `a` | no | `ḫaemX, lamX` | all extracted forms lack an i-medial after the onset |
| `36-05` | 覽 | `k\textoverset{a}{a}m\textsuperscript{˸vid}` | `k\textoverset{a}{a}m\textsuperscript{˸vid}` | `a` | no | `lamX` | all extracted forms lack an i-medial after the onset |
...
| `36-12` | 沾 | `tem` | `tem₂` | `b` | no | `ṭiem` | all extracted forms show an i-medial or a dedicated palatal onset |
| `36-14` | 炎 | `ram` | `ram` | `mixed` | no | `dam, hiem, yiemH, yiemX, chiem, ziem, śiemX, thamX, damH, damX, yiem` | the extracted forms point to both type a and type b |
| `36-18` | 冄 | `nam` | `nam` | `mixed` | no | `ñiemX, ñiem, nəm, nam, tham` | the extracted forms point to both type a and type b |
| `36-18` | 冉 | `nam` | `nam₂` | `mixed` | no | `ñiemX, ñiem, nemX, ñiemH, nam, tham` | the extracted forms point to both type a and type b |
| `36-21` | 㦰 | `sem` | `sem` | `mixed` | no | `tsiem, siem, ṣeam` | the extracted forms point to both type a and type b |
| `36-21` | 韱 | `sem` | `sem₂` | `mixed` | no | `siem, tsiem, ṣeam` | the extracted forms point to both type a and type b |
| `36-22` | 斬 | `tsam` | `tsam` | `mixed` | no | `tṣeamX, ṣaem, dzam, dzamH, dziemX, dẓaem, tsiem, tshiem` | the extracted forms point to both type a and type b |
| `36-23` | 毚 | `s\textoverset{a}{o}m` | `s\textoverset{a}{o}m` | `a` | no | `dẓaem, dẓeam, dẓeamH, dẓeamX, tṣhaemH, dẓaemH` | all extracted forms lack an i-medial after the onset |
| `36-26` | 凡 | `pom` | `pom` | `mixed` | no | `biəm, buwṅ, biəmX, biuwṅ, phiəmH` | the extracted forms point to both type a and type b |
| `36-26` | 風 | `prym` | `prym₂` | `b` | no | `piuwṅ, piuwṅH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `36-26` | 鳳 | `prym` | `prym` | `b` | no | `biuwṅH, piuwṅ, piuwṅH, biuwṅ` | all extracted forms show an i-medial or a dedicated palatal onset |
| `36-27` | 𨊠 | `pom` | `p\textoverset{b}{o}m₂` | `b` | yes | `biəmX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `36-27` | 氾 | `pom` | `p\textoverset{b}{o}m` | `b` | yes | `biəmH, phiəmH, biəmX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `37-01` | 合 | `kop` | `kop` | `mixed` | no | `həp, kəp, keap, giaep, kiaep, heap, kip, xip, jip` | the extracted forms point to both type a and type b |
| `37-01` | 翕 | `qhyp` | `qhyp` | `b` | no | `xip` | all extracted forms show an i-medial or a dedicated palatal onset |
| `37-02` | 及 | `ryp` | `ryp` | `b` | no | `gip, kip, xip, ṅip, giep` | all extracted forms show an i-medial or a dedicated palatal onset |
| `37-03` | 十 | `kyp` | `kyp` | `b` | no | `jip, cip` | all extracted forms show an i-medial or a dedicated palatal onset |
| `37-05` | 邑 | `qyp` | `qyp` | `b` | no | `qip, qyip` | all extracted forms show an i-medial or a dedicated palatal onset |
| `37-06` | 荅 | `typ` | `typ₃` | `a` | no | `təp, thap, thəp` | all extracted forms lack an i-medial after the onset |
| `37-08` | 執 | `tip` | `tip` | `mixed` | no | `cip, ṭip, ḍip, nep, ciep, tsip, ṭiyH, ciyH, temH` | the extracted forms point to both type a and type b |
| `37-09` | 沓 | `ryp` | `ryp` | `a` | no | `dəp` | all extracted forms lack an i-medial after the onset |
| `37-10` | 眔 | `ryp` | `ryp` | `a` | no | `dəp, thəp` | all extracted forms lack an i-medial after the onset |
| `37-10` | 遝 | `ryp` | `ryp₉` | `a` | no | `dəp, thəp` | all extracted forms lack an i-medial after the onset |
| `37-12` | 習 | `syp₂` | `syp₂` | `mixed` | no | `zip, yip, dep, ciep` | the extracted forms point to both type a and type b |
...
| `38-03` | 含 | `kym` | `kym₄` | `a` | no | `həm, həmH, həmX, ṅəmX` | all extracted forms lack an i-medial after the onset |
| `38-03` | 侌 | `kym` | `kym₅` | `b` | no | `qim, qimH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-03` | 陰 | `kym` | `kym₆` | `b` | no | `qim, qimH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-03` | 金 | `kym` | `kym₇` | `mixed` | no | `kim, kimX, khim, xim, gimX, ṅim, ṅimX, ṅəm` | the extracted forms point to both type a and type b |
| `38-03` | 欽 | `` | `` | `unknown` | no | `` |  |
| `38-04` | 咸 | `kym` | `kym` | `mixed` | no | `heam, heamX, keamX, keam, qeamX, kəmX, həmH, khəmX, xəmH, cim` | the extracted forms point to both type a and type b |
| `38-04` | 感 | `kym` | `kym₉` | `a` | no | `kəmX, həmH` | all extracted forms lack an i-medial after the onset |
| `38-05` | 臽 | `kom` | `kom` | `mixed` | no | `heamH, heamX, khəmX, həmX, dəmX, damH, damX, ṭhiemX, yiem, yiemH, zim` | the extracted forms point to both type a and type b |
| `38-05` | 閻 | `kom` | `k\textoverset{b}{o}m` | `b` | yes | `yiem, yiemH, zim, ṭhiemX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-07` | 音 | `qym` | `qym` | `mixed` | no | `qim, qyim, qimH, qəmH, xim` | the extracted forms point to both type a and type b |
| `38-11` | 甚 | `qym` | `qym` | `mixed` | no | `jimH, jimX, jim, ṭimH, ṭim, ṭhimX, cim, təm, ḍeamX, ḍim, tsiem, dəmX, thəmX, səmX, khəm, kheam, ṅəm` | the extracted forms point to both type a and type b |
| `38-11` | 戡 | `qym₂` | `qym₃` | `a` | no | `khəm, kheam, ṅəm` | all extracted forms lack an i-medial after the onset |
| `38-13` | 審 | `tym` | `tym` | `b` | no | `śimX, chimX, syimX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-14` | 冘 | `lum` | `lum` | `mixed` | no | `yim, ḍim, ḍimH, śimX, chimX, cimH, cimX, jim, təmX, təm, tamX, dəmX, thəmX` | the extracted forms point to both type a and type b |
| `38-15` | 㸒 | `rym` | `rym` | `b` | no | `yim` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-16` | 覃 | `lim` | `lim` | `mixed` | no | `dəm, yiemX, dziem, ziem, yim, zim, dəmX, thəm, demX` | the extracted forms point to both type a and type b |
| `38-18` | 林 | `rym` | `rym` | `mixed` | no | `lim, ləm, kim, kimH, gimH, gimX` | the extracted forms point to both type a and type b |
| `38-18` | 禁 | `rym` | `rym₂` | `b` | no | `kim, kimH, gimH, gimX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-19` | 稟 | `  *pim` | `  *pim` | `b` | no | `limX, pimX` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-20` | 品 | `pum` | `pum` | `b` | no | `phimX, lim, limH` | all extracted forms show an i-medial or a dedicated palatal onset |
| `38-21` | 貪 | `rym` | `rym` | `a` | no | `thəm, thəmX` | all extracted forms lack an i-medial after the onset |
| `38-24` | 念 | `nim` | `nim` | `mixed` | no | `nemH, ñimX, śimX, nep` | the extracted forms point to both type a and type b |
...
| `38-27` | 侵 | `tshim` | `tshim` | `b` | no | `tshim, siem, tsim, tshimX, tshiem, tsiem, tṣhim, tsimH` | all extracted forms show an i-medial or a dedicated palatal onset |
...
| `38-29` | 參 | `sum` | `sum` | `mixed` | no | `śim, tshəm, tṣhim, tshəmX, səmX, ṣim, ṣeam, ṣeamX` | the extracted forms point to both type a and type b |
