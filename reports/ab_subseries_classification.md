...
- Generated subgroup heads inspected: 950
- Subgroups newly marked with `a`: 114
- Subgroups newly marked with `b`: 107
- Uniform subgroups left unmarked because the root already signals the quality clearly: 329
- Mixed subgroups left unmarked: 396
...
| `11-06` | 屋 | `q\textoverset{a}{o}k\textsuperscript{·室}` | `q\textoverset{a}{o}k\textsuperscript{·室}` | `a` | no | `quwk, qaewk, quwH` | all extracted forms lack an i-medial after the onset |
