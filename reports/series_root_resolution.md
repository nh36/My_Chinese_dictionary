...
- Missing-series packets inspected: 370
- Packets with at least one root candidate: 370
- Packets with a single resolved provisional root: 370
...
| `02-04` | 丮→kak [*kʳaɡ] (None) | `kak` | `head_graph_oc_shengfu` |
