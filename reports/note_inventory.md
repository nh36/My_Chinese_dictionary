...
- Entries with at least one note: 487
- Total notes inventoried: 1825

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 699 |
| `curation_entry_note` | 952 |
...
| `source_reference` | 10 |
| `structural_internal` | 699 |
| `workflow_internal` | 957 |
