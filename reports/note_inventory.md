...
- Entries with at least one note: 331
- Total notes inventoried: 1366

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 566 |
| `curation_entry_note` | 640 |
| `curation_mc_investigation` | 117 |
...
| `source_reference` | 10 |
| `structural_internal` | 566 |
| `workflow_internal` | 645 |
