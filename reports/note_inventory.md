...
- Entries with at least one note: 319
- Total notes inventoried: 1322

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 549 |
| `curation_entry_note` | 616 |
...
| `source_reference` | 10 |
| `structural_internal` | 549 |
| `workflow_internal` | 621 |
