...
- Entries with at least one note: 179
- Total notes inventoried: 782

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 340 |
| `curation_entry_note` | 336 |
| `curation_mc_investigation` | 67 |
...
| `source_reference` | 10 |
| `structural_internal` | 340 |
| `workflow_internal` | 341 |
