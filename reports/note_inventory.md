...
- Entries with at least one note: 185
- Total notes inventoried: 805

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 349 |
| `curation_entry_note` | 348 |
| `curation_mc_investigation` | 69 |
...
| `source_reference` | 10 |
| `structural_internal` | 349 |
| `workflow_internal` | 353 |
