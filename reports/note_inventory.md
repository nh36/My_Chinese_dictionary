...
- Entries with at least one note: 263
- Total notes inventoried: 1109

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 475 |
| `curation_entry_note` | 504 |
...
| `source_reference` | 10 |
| `structural_internal` | 475 |
| `workflow_internal` | 509 |
