...
- Entries with at least one note: 203
- Total notes inventoried: 875

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 381 |
| `curation_entry_note` | 384 |
| `curation_mc_investigation` | 71 |
...
| `source_reference` | 10 |
| `structural_internal` | 381 |
| `workflow_internal` | 389 |
