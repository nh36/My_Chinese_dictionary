...
- Entries with at least one note: 445
- Total notes inventoried: 1715

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 674 |
| `curation_entry_note` | 868 |
...
| `source_reference` | 10 |
| `structural_internal` | 674 |
| `workflow_internal` | 873 |
