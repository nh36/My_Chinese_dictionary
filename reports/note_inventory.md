...
- Entries with at least one note: 475
- Total notes inventoried: 1793

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 692 |
| `curation_entry_note` | 928 |
...
| `source_reference` | 10 |
| `structural_internal` | 692 |
| `workflow_internal` | 933 |
