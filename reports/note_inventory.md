...
- Entries with at least one note: 361
- Total notes inventoried: 1479

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 610 |
| `curation_entry_note` | 700 |
...
| `source_reference` | 10 |
| `structural_internal` | 610 |
| `workflow_internal` | 705 |
