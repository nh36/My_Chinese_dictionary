...
- Entries with at least one note: 227
- Total notes inventoried: 970

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 418 |
| `curation_entry_note` | 432 |
| `curation_mc_investigation` | 81 |
...
| `source_reference` | 10 |
| `structural_internal` | 418 |
| `workflow_internal` | 437 |
