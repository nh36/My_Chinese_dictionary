...
- Entries with at least one note: 451
- Total notes inventoried: 1731

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 678 |
| `curation_entry_note` | 880 |
...
| `source_reference` | 10 |
| `structural_internal` | 678 |
| `workflow_internal` | 885 |
