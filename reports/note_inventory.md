...
- Entries with at least one note: 325
- Total notes inventoried: 1341

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 556 |
| `curation_entry_note` | 628 |
| `curation_mc_investigation` | 114 |
...
| `source_reference` | 10 |
| `structural_internal` | 556 |
| `workflow_internal` | 633 |
