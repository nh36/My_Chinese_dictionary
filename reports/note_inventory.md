...
- Entries with at least one note: 439
- Total notes inventoried: 1699

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 670 |
| `curation_entry_note` | 856 |
| `curation_mc_investigation` | 130 |
...
| `source_reference` | 10 |
| `structural_internal` | 670 |
| `workflow_internal` | 861 |
