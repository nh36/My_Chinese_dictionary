...
- Entries with at least one note: 191
- Total notes inventoried: 827

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 358 |
| `curation_entry_note` | 360 |
...
| `source_reference` | 10 |
| `structural_internal` | 358 |
| `workflow_internal` | 365 |
