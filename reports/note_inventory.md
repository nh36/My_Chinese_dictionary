...
- Entries with at least one note: 197
- Total notes inventoried: 851

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 370 |
| `curation_entry_note` | 372 |
| `curation_mc_investigation` | 70 |
...
| `source_reference` | 10 |
| `structural_internal` | 370 |
| `workflow_internal` | 377 |
