...
- Entries with at least one note: 257
- Total notes inventoried: 1086

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 464 |
| `curation_entry_note` | 492 |
| `curation_mc_investigation` | 91 |
...
| `source_reference` | 10 |
| `structural_internal` | 464 |
| `workflow_internal` | 497 |
