...
- Entries with at least one note: 293
- Total notes inventoried: 1225

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 518 |
| `curation_entry_note` | 564 |
...
| `source_reference` | 10 |
| `structural_internal` | 518 |
| `workflow_internal` | 569 |
