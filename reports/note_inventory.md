...
- Entries with at least one note: 481
- Total notes inventoried: 1809

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 696 |
| `curation_entry_note` | 940 |
...
| `source_reference` | 10 |
| `structural_internal` | 696 |
| `workflow_internal` | 945 |
