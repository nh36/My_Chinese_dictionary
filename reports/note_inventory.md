...
- Entries with at least one note: 367
- Total notes inventoried: 1500

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 619 |
| `curation_entry_note` | 712 |
...
| `source_reference` | 10 |
| `structural_internal` | 619 |
| `workflow_internal` | 717 |
