...
- Entries with at least one note: 433
- Total notes inventoried: 1681

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 665 |
| `curation_entry_note` | 844 |
...
| `source_reference` | 10 |
| `structural_internal` | 665 |
| `workflow_internal` | 849 |
