...
- Entries with at least one note: 463
- Total notes inventoried: 1762

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 685 |
| `curation_entry_note` | 904 |
...
| `source_reference` | 10 |
| `structural_internal` | 685 |
| `workflow_internal` | 909 |
