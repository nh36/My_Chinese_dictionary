...
- Entries with at least one note: 457
- Total notes inventoried: 1748

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 683 |
| `curation_entry_note` | 892 |
...
| `source_reference` | 10 |
| `structural_internal` | 683 |
| `workflow_internal` | 897 |
