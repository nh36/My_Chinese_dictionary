...
- Entries with at least one note: 373
- Total notes inventoried: 1519

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 626 |
| `curation_entry_note` | 724 |
...
| `source_reference` | 10 |
| `structural_internal` | 626 |
| `workflow_internal` | 729 |
