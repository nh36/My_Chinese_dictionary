...
- Entries with at least one note: 337
- Total notes inventoried: 1387

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 573 |
| `curation_entry_note` | 652 |
| `curation_mc_investigation` | 119 |
...
| `source_reference` | 10 |
| `structural_internal` | 573 |
| `workflow_internal` | 657 |
