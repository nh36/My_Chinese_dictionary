...
- Entries with at least one note: 421
- Total notes inventoried: 1654

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 662 |
| `curation_entry_note` | 820 |
...
| `source_reference` | 10 |
| `structural_internal` | 662 |
| `workflow_internal` | 825 |
