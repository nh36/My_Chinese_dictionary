...
- Entries with at least one note: 355
- Total notes inventoried: 1457

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 600 |
| `curation_entry_note` | 688 |
...
| `source_reference` | 10 |
| `structural_internal` | 600 |
| `workflow_internal` | 693 |
