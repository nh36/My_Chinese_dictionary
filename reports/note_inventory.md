...
- Entries with at least one note: 379
- Total notes inventoried: 1539

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 634 |
| `curation_entry_note` | 736 |
| `curation_mc_investigation` | 126 |
...
| `source_reference` | 10 |
| `structural_internal` | 634 |
| `workflow_internal` | 741 |
