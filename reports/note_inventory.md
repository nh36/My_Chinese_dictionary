...
- Entries with at least one note: 349
- Total notes inventoried: 1435

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 591 |
| `curation_entry_note` | 676 |
| `curation_mc_investigation` | 125 |
...
| `source_reference` | 10 |
| `structural_internal` | 591 |
| `workflow_internal` | 681 |
