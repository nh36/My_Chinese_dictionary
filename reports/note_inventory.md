...
- Entries with at least one note: 397
- Total notes inventoried: 1593

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 650 |
| `curation_entry_note` | 772 |
...
| `source_reference` | 10 |
| `structural_internal` | 650 |
| `workflow_internal` | 777 |
