...
- Entries with at least one note: 299
- Total notes inventoried: 1247

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 528 |
| `curation_entry_note` | 576 |
...
| `source_reference` | 10 |
| `structural_internal` | 528 |
| `workflow_internal` | 581 |
