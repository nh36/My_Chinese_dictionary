...
- Entries with at least one note: 469
- Total notes inventoried: 1778

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 689 |
| `curation_entry_note` | 916 |
...
| `source_reference` | 10 |
| `structural_internal` | 689 |
| `workflow_internal` | 921 |
