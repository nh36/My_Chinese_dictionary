...
- Entries with at least one note: 209
- Total notes inventoried: 899

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 390 |
| `curation_entry_note` | 396 |
| `curation_mc_investigation` | 74 |
...
| `source_reference` | 10 |
| `structural_internal` | 390 |
| `workflow_internal` | 401 |
