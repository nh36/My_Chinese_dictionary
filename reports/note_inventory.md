...
- Entries with at least one note: 287
- Total notes inventoried: 1204

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 510 |
| `curation_entry_note` | 552 |
| `curation_mc_investigation` | 103 |
...
| `source_reference` | 10 |
| `structural_internal` | 510 |
| `workflow_internal` | 557 |
