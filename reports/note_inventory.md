...
- Entries with at least one note: 343
- Total notes inventoried: 1412

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 583 |
| `curation_entry_note` | 664 |
| `curation_mc_investigation` | 122 |
...
| `source_reference` | 10 |
| `structural_internal` | 583 |
| `workflow_internal` | 669 |
