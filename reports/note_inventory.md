...
- Entries with at least one note: 182
- Total notes inventoried: 794

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 345 |
| `curation_entry_note` | 342 |
| `curation_mc_investigation` | 68 |
...
| `source_reference` | 10 |
| `structural_internal` | 345 |
| `workflow_internal` | 347 |
