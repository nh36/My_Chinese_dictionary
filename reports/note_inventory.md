...
- Entries with at least one note: 313
- Total notes inventoried: 1301

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 542 |
| `curation_entry_note` | 604 |
...
| `source_reference` | 10 |
| `structural_internal` | 542 |
| `workflow_internal` | 609 |
