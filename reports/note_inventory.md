...
- Entries with at least one note: 415
- Total notes inventoried: 1639

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 659 |
| `curation_entry_note` | 808 |
...
| `source_reference` | 10 |
| `structural_internal` | 659 |
| `workflow_internal` | 813 |
