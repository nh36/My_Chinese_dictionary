...
- Entries with at least one note: 499
- Total notes inventoried: 2236

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 1086 |
| `curation_entry_note` | 976 |
...
| `source_reference` | 10 |
| `structural_internal` | 1086 |
| `workflow_internal` | 981 |
