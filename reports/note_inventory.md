...
- Entries with at least one note: 269
- Total notes inventoried: 1131

## By source layer

| Source layer | Count |
| --- | ---: |
| `curation_division_note` | 484 |
| `curation_entry_note` | 516 |
| `curation_mc_investigation` | 92 |
...
| `source_reference` | 10 |
| `structural_internal` | 484 |
| `workflow_internal` | 521 |
